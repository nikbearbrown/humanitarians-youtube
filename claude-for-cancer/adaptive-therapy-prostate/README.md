...
# Research Adaptive Therapy with Claude: Managing Resistance Instead of Maximizing Kill
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: cancer-medicine/chapters/08-tumor-heterogeneity-and-clonal-evolution.md
