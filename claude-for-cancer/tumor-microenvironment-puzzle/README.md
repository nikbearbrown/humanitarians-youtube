...
# Research the Tumor Microenvironment Puzzle with Claude: Why Less Than 15% Are Cancer Cells
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: cancer-medicine/chapters/05-the-tumor-microenvironment-components.md
