...
This video explains angiogenesis: the tumor's new blood supply through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/01-angiogenesis-the-tumors-new-blood-supply.md
