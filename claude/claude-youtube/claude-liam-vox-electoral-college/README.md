...
# The Electoral College, explained (excerpt recreation)
...
The current plan contains **24 beats**. Its runtime is 132.29. The source recorded by the project is: See the local source and fact-check files.
