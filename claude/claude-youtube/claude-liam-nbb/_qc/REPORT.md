...
|------|-----------|-------|--------|
| B00 | 1s | ClaudeComposerAsk — "Ciao, Kore" + "Kore, in for Humanitarians AI." + command + output list | PASS |
...
| BOUT | 261s | ClaudeTitleOutro — "Claude, Torn Down." / @HumanitariansAI / "Kore, in for Humanitarians AI." | PASS |
...
9. **BOUT** — "Claude, Torn Down." / @HumanitariansAI / "Kore, in for Humanitarians AI.": PASS
