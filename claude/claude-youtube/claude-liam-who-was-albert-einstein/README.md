...
**Topic:** PHYSICS · HISTORY OF SCIENCE

This is Humanitarians.

The current plan contains **13 beats**. Its runtime is 120. The source recorded by the project is: See the local source and fact-check files.
