...
# Why the Recursion Tree Rows All Cost the Same
...
The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: youtubers/chapters/algorithms-doubling-and-halving-cancel-to-n-log-n.md
