...
# Build the Engine: Recommend a Move — With Uncertainty

## What this video is about

**Topic:** COMPUTATIONAL SKEPTICISM — BUILD THE ENGINE (E2/9)

This is Humanitarians.

The current plan contains **9 beats**. Its runtime is derived from 9 beats. The source recorded by the project is: INFO 7375 Computational Skepticism for AI — Reallocation Engine (100 pts)
