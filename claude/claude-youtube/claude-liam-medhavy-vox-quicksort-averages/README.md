...
# Why Quicksort's Average Hides Inside a Harmonic Sum
...
The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: youtubers/chapters/algorithm-analysis-quicksort-averages-2n-ln-n-comparisons.md
