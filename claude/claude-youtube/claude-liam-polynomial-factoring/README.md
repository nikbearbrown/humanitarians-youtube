...
# Polynomial Factoring — The Decision Tree That Replaces Guessing
...
The current plan contains **12 beats**. Its runtime is 120. The source recorded by the project is: college-algebra-bundle-with-llms/chapters/01-prerequisites.md
