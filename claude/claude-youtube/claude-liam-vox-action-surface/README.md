...
# Why the Agent That Can Do More Can Go Wrong More
...
The current plan contains **11 beats**. Its runtime is 91.28. The source recorded by the project is: claude-agentic-ai/chapters/03-tools-permissions-and-the-action-surface.md
