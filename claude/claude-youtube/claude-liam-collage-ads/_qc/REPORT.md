...
## Build facts
- Runtime: 225.9s | Beats: 11/11 VIDEO | Audio: Kokoro af_kore (free)
- Streams: video + audio confirmed (compile.py)

## Frame verification
| Timestamp | Beat | Pattern | Result |
|---|---|---|---|
| 1s | B00 | ClaudeComposerAsk | PASS — "COLLAGE-ADS · SKILL TEARDOWN", "Kore, in for Humanitarians AI.", "Cześć, Kore", 4 output lines |
...
| 223s | BOUT | ClaudeTitleOutro | PASS — "Claude, Collaged." / @HumanitariansAI / "Kore, in for Humanitarians AI." |

## 9-point rubric
1. IN-FOR-BEAR: "Kore, in for Humanitarians AI." visible at 1s — PASS
2. HELLO: "Cześć, Kore" (Polish) in B00 — PASS
