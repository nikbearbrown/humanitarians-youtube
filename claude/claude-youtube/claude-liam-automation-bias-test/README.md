...
# Test Automation Bias by Running the Same Output With and Without Review with Claude
...
The current plan contains **11 beats**. Its runtime is 95.92. The source recorded by the project is: claude-agentic-ai/chapters/09-failure-modes-of-agentic-work.md
