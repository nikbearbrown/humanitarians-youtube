...
# Build a Prompt Card Library with Claude
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: claude-prompt-engineering/chapters/12-building-a-reusable-prompt-library.md
