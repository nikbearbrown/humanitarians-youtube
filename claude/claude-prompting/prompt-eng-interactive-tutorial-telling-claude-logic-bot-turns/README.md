...
# Why telling Claude "you are a logic bot" turns a wrong answer right

## What this video is about

**Topic:** Role text that changes correctness, not just tone

Given a logic problem with a definite "yes," Claude says it lacks information and gets it wrong. Prime it with "You are a logic bot" and, on the same problem, it answers correctly.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/prompt-eng-interactive-tutorial/Anthropic 1P/03_Assigning_Roles_Role_Prompting.ipynb`
