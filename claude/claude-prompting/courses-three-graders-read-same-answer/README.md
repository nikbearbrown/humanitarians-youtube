...
# Why three graders read the same answer and hand back three different grades

## What this video is about

**Topic:** Each grader catches a different failure mode

Output "The capital of France is Paris, France." Code grader checks format → pass. Human grader sees the redundant "France, France" → marks it down. Model grader flags the unnecessary words → scores 0.8, not 1.0.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/courses/prompt_evaluations/README.md`
