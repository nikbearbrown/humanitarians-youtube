...
# Why You Should Write the Test Before You Write the Prompt
...
The current plan contains **16 beats**. Its runtime is 200.12. The source recorded by the project is: claude-prompt-engineering/chapters/05-evaluation-criteria-before-output.md
