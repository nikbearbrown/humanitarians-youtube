...
# Why Claude Invents Claims When You Ask It to Improve Your Writing
...
The current plan contains **15 beats**. Its runtime is 219.72. The source recorded by the project is: claude-prompt-engineering/chapters/08-prompts-for-writing-and-editing.md
