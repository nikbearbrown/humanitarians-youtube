...
# Claude Writes Your Prompt For You

## What this video is about

**Topic:** PROMPT ENGINEERING · Metaprompt

The idea that Claude can draft my prompt for me is fascinating, but I want to understand what the metaprompt is actually doing rather than just copy its output. Take a vague task of mine, say classifying support tickets by urgency, and: (1) walk me through the structure the metaprompt generates, naming why each section is there, (2) show me two spots where its generated prompt is generic and I'd hand-tune it for my…
