...
**Topic:** PROMPT ENGINEERING · LESSON 3

The claim that assigning Claude a role changes everything makes me curious whether the effect is real reasoning or just tone. I want to test that. Help me: (1) design an experiment comparing the same math problem answered with no role versus 'you are a logic professor,' and say what output difference I should look for; (2) explain mechanistically why a role in the system prompt shifts the response distribution; (3)…
