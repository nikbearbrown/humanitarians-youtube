...
# Precognition: Make Claude Think Before It Speaks

## What this video is about

**Topic:** PROMPT ENGINEERING · Chain-of-Thought

Making Claude think before it speaks sounds like magic until I ask why writing out reasoning first changes the final answer at all. Take a word problem where the naive answer is a tempting trap: (1) show me the model answering immediately and getting it wrong, (2) then force step-by-step reasoning before the conclusion and point to the exact step where the trap gets caught, (3) explain whether hiding that reasoning…
