...
# Why the tool-calling loop stops — the model decides, not your code

## What this video is about

**Topic:** Automatic tool-orchestration loop and its termination

`tool_runner()` re-prompts after every tool result and keeps going; the caller never sets an iteration count or a stop flag.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/anthropic-sdk-python/tools.md`
