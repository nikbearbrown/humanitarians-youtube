...
# Why a helpful Claude invents an answer — and permission to say "I don't know" stops it

## What this video is about

**Topic:** Helpfulness pressure as a hallucination source

Asked for Matterport's subscriber count "as of May 31, 2020," Claude latches onto nearby distractor figures and states a wrong number. Told to first extract the exact quotes that answer the question, it finds none match — and correctly reports the document doesn't say.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/prompt-eng-interactive-tutorial/Anthropic 1P/08_Avoiding_Hallucinations.ipynb`
