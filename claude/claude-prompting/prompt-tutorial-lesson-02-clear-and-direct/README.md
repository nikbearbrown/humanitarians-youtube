...
# Claude Is Not a Mind Reader

## What this video is about

**Topic:** PROMPT ENGINEERING · Being Clear and Direct

The framing that Claude is not a mind reader stuck with me, because my vague prompts really do get vague answers. I want to practice closing that gap. Help me: (1) take a lazy instruction like 'summarize this' and rewrite it with explicit audience, length, and format so the intent is unambiguous; (2) explain why spelling out the desired output shape beats hoping the model infers it; (3) show me one prompt that reads…
