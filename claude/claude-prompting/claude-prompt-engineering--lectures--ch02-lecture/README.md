...
This video explains chapter 2: context: what claude needs and what it does not through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/02-context-what-claude-needs-and-what-it-does-not.md
