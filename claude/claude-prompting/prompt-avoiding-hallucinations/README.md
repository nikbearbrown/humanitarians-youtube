...
# Grounding: The Fix for Hallucinations

## What this video is about

**Topic:** PROMPT ENGINEERING · Avoiding Hallucinations

Grounding as the fix for hallucinations makes intuitive sense, but I want to understand exactly how supplying source text changes what the model does. Walk me through: (1) why giving Claude a document to quote from reduces fabrication compared to relying on parametric memory; (2) how I'd instruct it to say 'not found in the source' instead of inventing an answer; (3) a test case where a poorly grounded prompt still…

The current plan contains **7 beats**. Its runtime is derived from 7 beats. The source recorded by the project is: Anthropic Prompt Engineering Tutorial Lesson 8
