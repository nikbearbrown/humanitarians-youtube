...
# Build a Constraint Extractor with Claude
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: claude-prompt-engineering/chapters/03-constraints-and-boundaries.md
