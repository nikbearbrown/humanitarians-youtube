...
# Why Claude can't think silently — reasoning only counts when it's on the page

## What this video is about

**Topic:** Reasoning has to be emitted to exist

A two-sentence review whose second line reverses the first. Asked for a verdict directly, Claude takes "unrelated" too literally and answers wrong. Told to reason first inside `<brainstorm>` tags, it works through both sentences and flips to the correct verdict.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/prompt-eng-interactive-tutorial/Anthropic 1P/06_Precognition_Thinking_Step_by_Step.ipynb`
