...
# Why 'Clean Up This Folder' Is a Dangerous Instruction
...
The current plan contains **15 beats**. Its runtime is 236.89. The source recorded by the project is: claude-prompt-engineering/chapters/11-prompts-as-handoffs-to-claude-code-and-cowork.md
