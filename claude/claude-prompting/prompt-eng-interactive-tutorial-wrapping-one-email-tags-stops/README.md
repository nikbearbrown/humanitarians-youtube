...
# Why wrapping one email in tags stops Claude from writing "Dear Claude"

## What this video is about

**Topic:** Marking where data ends and instructions begin

Template "Yo Claude, [EMAIL] — make this more polite." User's email happens to open "Yo Claude." After substitution Claude reads the whole thing as the email and begins its rewrite "Dear Claude." Wrap the email in `<email>...</email>` and the confusion disappears.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/prompt-eng-interactive-tutorial/Anthropic 1P/04_Separating_Data_and_Instructions.ipynb`
