...
# The Medical Prompt: Four Guardrails That Can't Be Missing

## What this video is about

**Topic:** PROMPT ENGINEERING · High-Stakes AI

The claim that a high-stakes medical prompt has four guardrails that cannot be missing really landed for me, because in that domain a confident wrong answer is dangerous. Help me build one properly: (1) name what those four guardrails likely are — scope limits, uncertainty flags, source grounding, and a defer-to-clinician clause; (2) write a prompt for a symptom-checker assistant that bakes all four in; (3) show me…
