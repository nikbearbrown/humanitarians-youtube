...
# Why swapping the order of two arguments flips Claude's verdict

## What this video is about

**Topic:** Positional bias in close calls

A review with one positive and one negative sentence. Positive-then-negative → Claude judges it negative. Swap to negative-then-positive → Claude judges it positive. Same words, reordered; the verdict follows the second option.
