...
# Write a PRD Like a PM, Part 1: Problem & Solution

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 2 — PRD PART 1: PROBLEM & SOLUTION (20 PTS)

This is Humanitarians.

The current plan contains **11 beats**. Its runtime is derived from 11 beats. The source recorded by the project is: INFO 7375 Assignment 2 brief — Plan Your Madison Project Like a Pro
