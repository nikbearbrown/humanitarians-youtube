...
# Ship It: Slides + Live URLs + Demo Access

## What this video is about

**Topic:** INFO 7375 CAPSTONE — SHIP IT (E6/6)

This is Humanitarians.

The current plan contains **8 beats**. Its runtime is derived from 8 beats. The source recorded by the project is: INFO 7375 Capstone — Complete Brand System (200 pts, due 2026-08-14)
