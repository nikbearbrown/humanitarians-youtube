...
**Topic:** CLAUDE + VERCEL MCP

This is Kore for Humanitarians AI.

The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: Research prompt: Connect Claude to Vercel (Bear Brown); vercel.com/docs/agent-resources/vercel-mcp + /tools, verified 2026-07-18
