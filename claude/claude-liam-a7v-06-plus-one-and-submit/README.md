...
# Madison +1: Final Audit + Submit

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 7 (VISUAL) — MADISON +1 + SUBMIT (E6/6)

This is Liam for Humanitarians AI.

The current plan contains **9 beats**. Its runtime is derived from 9 beats. The source recorded by the project is: INFO 7375 Assignment 7 (Visual) brief — Madison +1 audit, PDF export, Figma board, Canvas submit; due 2026-07-17
