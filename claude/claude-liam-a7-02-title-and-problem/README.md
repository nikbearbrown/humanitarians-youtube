...
# The First Two Minutes: Title + Problem (Slides 1–2)

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 7 — TITLE + PROBLEM (E2/7)

This is Humanitarians.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 7 brief — Video Pitch to Investors: Slides 1–2 (title + problem)
