...
| Frame | Beat | Notes |
|---|---|---|
| frame_16s.png | B00 cold open | ClaudeComposerAsk: "Hola, Kore" greeting, command/output visible, @HumanitariansAI, terracotta asterisk |
...
| frame_278s.png | BOUT outro | ClaudeTitleOutro: "Asana API." title, @HumanitariansAI, subline |
...
- Greeting: "Hola, Kore" (rotation #28)
