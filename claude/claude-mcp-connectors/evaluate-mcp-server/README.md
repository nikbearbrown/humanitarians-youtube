...
# Evaluate an MCP Server Before Connecting It with Claude
...
The current plan contains **11 beats**. Its runtime is 99.99. The source recorded by the project is: claude-agentic-ai/chapters/06-mcp-and-external-capabilities.md
