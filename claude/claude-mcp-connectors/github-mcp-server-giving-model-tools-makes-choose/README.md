...
# Why giving a model more tools makes it choose worse

## What this video is about

**Topic:** Dynamic tool discovery

"Create a GitHub repository." With all ~50 tools exposed the model reaches for `create_pull_request`; with only the `repos` toolset enabled it lands on `create_repository` immediately.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/github-mcp-server/README.md`
