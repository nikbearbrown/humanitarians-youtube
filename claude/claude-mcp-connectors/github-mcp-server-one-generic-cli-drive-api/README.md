...
# Why one generic CLI can drive an API it has never seen

## What this video is about

**Topic:** Schema-driven command generation

`mcpcurl tools get_issue --owner golang --repo go` returns real results, though mcpcurl has no built-in knowledge of `get_issue` or its flags.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/github-mcp-server/cmd/mcpcurl/README.md`
