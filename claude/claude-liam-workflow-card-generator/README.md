...
# Generate a Reusable Workflow Card from a Successful Task
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: claude-cowork/chapters/11-building-a-reusable-cowork-workflow.md
