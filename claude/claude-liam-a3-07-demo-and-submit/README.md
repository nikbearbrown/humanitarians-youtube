...
# The Demo + Ship the 4 Canvas Files

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 3 — DEMO AND SUBMIT (E7/7)

This is Liam for Humanitarians AI.

The current plan contains **8 beats**. Its runtime is derived from 8 beats. The source recorded by the project is: INFO 7375 Assignment 3 brief — Shop for Ingredients: Collect Your Madison Data
