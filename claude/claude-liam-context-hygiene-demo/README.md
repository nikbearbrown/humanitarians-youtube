...
# Context Hygiene: Prune Before You Paste
...
The current plan contains **10 beats**. Its runtime is 88. The source recorded by the project is: See the local source and fact-check files.
