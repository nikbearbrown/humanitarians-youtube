...
# Kokoro: The 8 Mandarin Voices

## What this video is about

**Topic:** KOKORO — MANDARIN 8

This is Liam for Humanitarians AI.

The current plan contains **12 beats**. Its runtime is 77.6. The source recorded by the project is: See the local source and fact-check files.
