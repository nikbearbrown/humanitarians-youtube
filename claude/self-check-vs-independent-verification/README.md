...
# Compare Self-Check vs. Independent Verification on an Agent Output with Claude
...
The current plan contains **11 beats**. Its runtime is 99.4. The source recorded by the project is: claude-agentic-ai/chapters/08-verification-is-the-control-system.md
