...
# Why Your Examples Teach More Than Your Instructions
...
The current plan contains **16 beats**. Its runtime is 174.62. The source recorded by the project is: claude-prompt-engineering/chapters/04-examples-counterexamples-and-style.md
