...
|------|-------------|-----|
| B01–B04 (Manim) | LOGO LAW — Manim renders have no @HumanitariansAI corner watermark | Add NBB watermark to Manim scene source or add post-compose overlay |
...
- LOGO LAW fix: add text watermark `@HumanitariansAI` to bottom-right of each Manim scene in animated_graphics.py or individual scenes.py
