...
# Translate a Causal Claim Across Three Registers with Claude
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: causal-reasoning/chapters/02-three-words-for-the-same-problem.md
