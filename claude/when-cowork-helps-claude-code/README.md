...
[@HumanitariansAI](https://www.youtube.com/@HumanitariansAI). The true story of building the `installs`
...
# When Cowork Can Help Claude Code

## What this video is about

**Topic:** A SECOND SET OF EYES

This is Kore for Humanitarians AI.

The current plan contains **18 beats**. Its runtime is 233.9. The source recorded by the project is: See the local source and fact-check files.
