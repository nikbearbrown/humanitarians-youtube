...
# Build and Test a Handoff Condition Protocol with Claude Code
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: claude-code-for-students/chapters/09-handoff-conditions-dangerous-middle.md
