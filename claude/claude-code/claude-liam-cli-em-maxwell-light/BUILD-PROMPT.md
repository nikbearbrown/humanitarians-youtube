...
Build one CLI video reel for the claude-liam brand (Kore, in for Humanitarians AI; footer @HumanitariansAI; Kokoro af_kore).
...
Required spine:
- B00 INTRO: Claude terminal "Bonjour, Kore" (ClaudeComposerAsk cold open)
...
- B09 OUTRO: ClaudeTitleOutro @HumanitariansAI

Constraints:
- brand: claude-liam, engine: kokoro, voice: af_kore, NOT ElevenLabs
