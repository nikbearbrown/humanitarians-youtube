...
# Why typing one word can multiply your API bill 100×

## What this video is about

**Topic:** Reasoning-budget keywords as a hidden cost parameter

The same architectural analysis costs $0.003 with "think" and $0.34 with "ultrathink" — same codebase, same question, near-identical visible output.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-code-monitoring-guide/claude_code_roi_full.md`
