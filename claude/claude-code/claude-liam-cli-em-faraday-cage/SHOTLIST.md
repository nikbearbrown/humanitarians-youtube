# SHOTLIST — claude-liam-cli-em-faraday-cage

## Machine-renderable beats (Remotion + Manim)
...
| Beat | Visual intent | Owner |
|------|---------------|-------|
| B01 | Title card: "Faraday cage — field inside = 0 (Gauss)" + "Only if copper >> skin depth" | SLATE OK |
| B07 | Recap card: formula + three-material table | SLATE OK |
