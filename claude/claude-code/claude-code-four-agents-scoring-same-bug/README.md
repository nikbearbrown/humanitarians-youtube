...
# Why four agents scoring the same bug beats one strong reviewer

## What this video is about

**Topic:** Consensus scoring as a confidence oracle

Agent 1 flags "missing null check" (75), Agent 2 flags it (90), Agents 3 and 4 don't. The system averages to 82.5, clears the 80 threshold, and posts — one agent was sure, two doubted, consensus narrowly includes it.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-code/plugins/code-review/README.md`
