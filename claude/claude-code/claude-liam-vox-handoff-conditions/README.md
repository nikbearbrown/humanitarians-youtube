...
The current plan contains **12 beats**. Its runtime is 193.58. The source recorded by the project is: claude-code-for-teachers/chapters/05-handoff-conditions.md
