...
This video explains bridge — from tools that save time to tools that change what's possible through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/11-bridge-tools-that-change-whats-possible.md
