...
This video explains chapter 14 — your first full build: from problem to verified output through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/14-first-full-build.md
