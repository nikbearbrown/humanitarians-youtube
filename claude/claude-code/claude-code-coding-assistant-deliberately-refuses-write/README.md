...
# Why a coding assistant deliberately refuses to write the 6 lines that matter

## What this video is about

**Topic:** Guided blanks at decision points (learning output style)

Implementing a rate limiter, Claude auto-fills the class, imports, and tests, then leaves the token-bucket refill calculation as a stubbed blank with a comment naming the two approaches — and asks the developer to write those ~6 lines before it continues.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-code/plugins/learning-output-style/`
