...
This video explains chapter 11 — building the simulation: conducting at full complexity through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/13-building-the-simulation.md
