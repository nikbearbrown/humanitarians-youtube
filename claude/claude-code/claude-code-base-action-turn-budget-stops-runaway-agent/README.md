...
# Why a turn budget stops a runaway agent more cleanly than a stopwatch

## What this video is about

**Topic:** Turn budgets as circuit breakers for agentic loops

With `max_turns: 5`, Claude reads files (turn 1), writes changes (turns 2–4), returns a summary (turn 5); the workflow exits with bounded, committed work. A 45-second wall-clock timeout instead fires mid-file-write, leaving a half-written file.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-code-base-action/README.md`
