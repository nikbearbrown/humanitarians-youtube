...
The current plan contains **13 beats**. Its runtime is 238.13. The source recorded by the project is: claude-code-for-teachers/chapters/04-prompts-to-specifications.md
