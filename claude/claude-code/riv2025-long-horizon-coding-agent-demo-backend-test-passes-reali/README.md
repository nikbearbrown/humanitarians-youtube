...
# Why a backend test that passes in reality stays permanently "failing"

## What this video is about

**Topic:** Verification gates that pattern-match the wrong artifact

The verification gate required a Playwright screenshot as proof. Backend code produces no browser output, so every backend test stayed "unverified"; the agent rationally stopped writing them. Adding a text-artifact path unlocked 18 backend + 36 frontend tests at once.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/riv2025-long-horizon-coding-agent-demo/CLAUDE.md`
