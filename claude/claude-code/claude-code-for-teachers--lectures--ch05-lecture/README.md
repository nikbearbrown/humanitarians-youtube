...
This video explains chapter 4 — handoff conditions: the gate between steps through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/05-handoff-conditions.md
