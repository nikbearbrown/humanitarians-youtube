...
# Why doubling your Claude Code session time doesn't double your output

## What this video is about

**Topic:** The session-duration productivity cliff

A team averaging 40-minute sessions ships fewer PRs per sprint than one averaging 28 minutes, despite sessions 40% longer.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-code-monitoring-guide/sample-report-output.md`
