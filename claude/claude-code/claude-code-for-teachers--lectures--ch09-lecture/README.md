...
This video explains chapter 8 — the dangerous middle: when claude is right and wrong simultaneously through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/09-dangerous-middle.md
