...
# Why the same eval() is a real bug in one file and noise in another

## What this video is about

**Topic:** Semantic understanding vs. pattern-based detection

The identical hardcoded key is excluded in `test_config.py` and reported in `main.py` where it handles user input; a pattern matcher flags both equally.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-code-security-review/README.md`
