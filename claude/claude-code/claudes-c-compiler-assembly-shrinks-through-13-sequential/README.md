...
# Why assembly shrinks through 13 sequential filters, not one

## What this video is about

**Topic:** Multi-stage peephole optimization

The dead pair `mov %eax,%ebx; mov %ebx,%eax` survives until pass 7, because an earlier dead-store elimination first removes a store that made the moves look live.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claudes-c-compiler/src/backend/README.md`
