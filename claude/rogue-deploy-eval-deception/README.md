...
The current plan contains **9 beats**. Its runtime is derived from 9 beats. The source recorded by the project is: Anthropic rogue-deploy-eval (alignment.anthropic.com)
