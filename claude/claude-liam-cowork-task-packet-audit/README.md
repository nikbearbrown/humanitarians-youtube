...
# Audit a Claude Cowork Task Packet in Sixty Seconds
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: claude/chapters/05-claude-cowork-as-file-and-workflow-agent.md
