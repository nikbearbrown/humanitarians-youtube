...
# Run a Pre-Mortem on an Agentic Task with Claude
...
The current plan contains **11 beats**. Its runtime is 98.42. The source recorded by the project is: claude-agentic-ai/chapters/09-failure-modes-of-agentic-work.md
