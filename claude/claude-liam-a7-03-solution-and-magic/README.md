...
# Sell the Solution & the Magic, Simplified (Slides 3–4)

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 7 — SOLUTION + MAGIC (E3/7)

This is Liam for Humanitarians AI.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 7 brief — Video Pitch to Investors: Slides 3–4 (solution + magic)
