...
# One More Touchpoint (+5): Newsletter, Social Set, or Pitch Template

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 8 — BONUS TOUCHPOINT

This is Liam for Humanitarians AI.

The current plan contains **9 beats**. Its runtime is derived from 9 beats. The source recorded by the project is: INFO 7375 Assignment 8 brief — Building Your Live Website, Resumes & LinkedIn Header
