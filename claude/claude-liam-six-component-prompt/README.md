...
# The Six-Component Prompt

## What this video is about

**Topic:** PROMPTING AS SPEC · CAPS

This is Liam for Humanitarians AI.

The current plan contains **10 beats**. Its runtime is 83. The source recorded by the project is: See the local source and fact-check files.
