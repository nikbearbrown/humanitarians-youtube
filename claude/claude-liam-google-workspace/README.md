...
**Topic:** CLAUDE + GMAIL · CALENDAR · DRIVE

This is Kore for Humanitarians AI.

The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: Research prompt: Claude + Gmail / Google Workspace (Bear Brown); support.claude.com Google Workspace connectors, verified 2026-07-18
