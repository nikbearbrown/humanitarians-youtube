...
# Why Claude spends 5000 thinking tokens on "2+2" and 100 on a hard proof

## What this video is about

**Topic:** Adaptive Thinking in Language Models

A simple factual question ("What color is the sky?") vs. a complex derivation ("Show me the error in this proof").
