...
**Topic:** CANVAS DESIGN · ANTHROPIC SKILL

Ciao — this is Liam, in for Bear. Give Claude a request — create a poster for a jazz festival. What comes back is not a document. It is a two-act performance. First, Claude writes a design philosophy — a manifesto for an art movement. Second, Claude uses that philosophy to generate a PDF or PNG canvas. Ninety percent visual. Ten percent text. The philosophy is the instruction set. Let me show you how it works.
