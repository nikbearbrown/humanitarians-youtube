...
**Topic:** SKILL DEVELOPMENT · CLAUDE CODE SKILL

Aloha — this is Liam, in for Bear. Ask Claude to create a skill, add a skill to a plugin, write a new skill, improve a skill description, or organize skill content — the Skill Development skill fires. A skill is a self-contained package: a SKILL.md file with YAML frontmatter and a markdown body, plus optional bundled resources — scripts for deterministic code, references for documentation loaded as needed, and asset…
