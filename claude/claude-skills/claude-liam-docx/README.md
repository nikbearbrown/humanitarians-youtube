...
Olá — this is Liam, in for Bear. Ask Claude to create a polished technical report as a Word document with a table of contents, headings, and page numbers. Before Claude writes a line of code, the docx skill fires. A dot-docx file is a ZIP archive containing XML. That is the insight. Let me show you the two paths.
