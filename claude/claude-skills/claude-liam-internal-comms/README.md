...
**Topic:** INTERNAL COMMS · ANTHROPIC SKILL

Merhaba — this is Liam, in for Bear. Ask Claude to write a weekly update for your team. The internal-comms skill fires. First: identify the type. Is this a 3P update, a newsletter, an FAQ, a status report? Then load the matching guideline file. Each file has its own format, tone rules, and tool sources. The skill is a router, not a writer. Let me show you what each type actually requires.
