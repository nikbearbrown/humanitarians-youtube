...
Olá — this is Liam, in for Bear. Ask Claude to make an animated GIF for Slack. The Slack GIF Creator fires. It knows Slack's exact specs: emoji GIFs at 128 by 128 pixels, message GIFs at 480, FPS between 10 and 30, colors between 48 and 128. It has three utilities: GIFBuilder for assembling and optimizing frames, validators to check Slack compliance, and easing functions for smooth motion. The animation logic itself…
