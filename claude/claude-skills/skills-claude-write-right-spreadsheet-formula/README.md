...
# Why Claude can write the right spreadsheet formula and the file still shows the wrong number

## What this video is about

**Topic:** Formula string vs. cached value in .xlsx

Cell C5 is set to `=B5*(1+B6)` with B5=100, B6=0.05. Open the workbook: C5 reads 100, not 105. The formula is right; the number is stale — until a real engine recalculates.
