...
**Topic:** DOC CO-AUTHORING · ANTHROPIC SKILL

Guten Tag — this is Liam, in for Bear. Ask Claude to write a technical spec for a new API. Most of the time, Claude writes for you, not for your readers. The doc-coauthoring skill changes that. It runs a three-stage workflow: close the knowledge gap first, build section by section second, and test with a reader who wasn't in the room. Let me show you how it works.
