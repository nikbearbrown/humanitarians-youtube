...
Hei — this is Kore, in for Humanitarians AI. Ask Claude to build a landing page with a strong visual identity. Before it writes a line of CSS, the frontend-design skill fires. The first thing it says: there are three looks every AI defaults to, and this brief probably does not want any of them. The skill positions itself as a design lead, not a template factory. Let me show you what it requires.
