...
Ciao — this is Kore, in for Humanitarians AI. Ask Claude to build a pitch deck, parse a presentation, or update existing slides. The PPTX skill fires. It does not reach for python-pptx. It routes: markitdown to read, the editing workflow for template work, pptxgenjs to create from scratch. And it has a design mandate — boring slides are explicitly prohibited. Let me show you the routing logic, the design rules, and…
