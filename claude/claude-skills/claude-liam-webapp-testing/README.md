...
Merhaba — this is Liam, in for Bear. Ask Claude to test a local web application — verify a button click, check a form submission, capture a screenshot of a UI state. The Web Application Testing skill fires. It is not a CI testing framework and it does not write test suites. It is a Playwright-based reconnaissance-and-action toolkit: decide first whether your app is static HTML or a dynamic server; follow the decisio…
