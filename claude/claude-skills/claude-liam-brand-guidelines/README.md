...
Hola — this is Liam, in for Bear. Give Claude a PowerPoint and ask it to make it look like Anthropic made it. What comes back is a slide deck in the exact Anthropic palette — that dark near-black, the cream, the terracotta orange. Poppins on the headings, Lora on the body. Not a guess. The actual brand. A twelve-hundred word instruction file told Claude exactly what to do. Let me show you the file.
