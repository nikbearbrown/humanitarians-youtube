...
# Why a 50-round agent survives past its own memory limit

## What this video is about

**Topic:** Compacting growing context in long agent sessions

A coding agent runs 50 rounds of tool calls across a 2-hour session; context approaches the token ceiling mid-task.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/skills/skills/claude-api/go/claude-api/README.md`
