...
# Why a number's color in a financial model tells you whether you're allowed to touch it

## What this video is about

**Topic:** Provenance-by-color in spreadsheet models

A revenue projection holds a blue 1,000 (input), a black 1,050 (=units×(1+growth)), a green cell pulled from another tab, and a red cell linked to an external file. Four identical-looking numbers, four different meanings.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/skills/skills/xlsx/SKILL.md`
