...
Brand: `claude-liam` · Voice: Kokoro `af_kore` · Engine: free/local

## Beat map

| Beat | Pattern | Content |
|---|---|---|
| B00 | ClaudeComposerAsk | Cold open — Hei Kore, frontend-design fires on design request |
...
| BOUT | ClaudeTitleOutro | Outro — Frontend Design · Kore, in for Humanitarians AI |
