...
Bonjour — this is Kore, in for Humanitarians AI. Ask Claude to add adaptive thinking to your Python app. Before Claude writes a single line, a skill fires — reads a reference, checks a drift table, confirms the exact model ID. That skill is called claude-api, and today we tear it down.
