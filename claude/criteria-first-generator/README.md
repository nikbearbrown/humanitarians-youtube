...
# Build a Criteria-First Prompt Generator with Claude
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: claude-prompt-engineering/chapters/05-evaluation-criteria-before-output.md
