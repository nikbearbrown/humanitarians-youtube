...
The current plan contains **14 beats**. Its runtime is 211.78. The source recorded by the project is: claude-code-for-teachers/chapters/02-first-terminal-session.md
