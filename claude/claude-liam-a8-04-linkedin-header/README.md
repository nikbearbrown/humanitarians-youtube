...
# Design a LinkedIn Header That Actually Works (1584 × 396)

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 8 — LINKEDIN HEADER

This is Humanitarians.

The current plan contains **12 beats**. Its runtime is derived from 12 beats. The source recorded by the project is: INFO 7375 Assignment 8 brief — Building Your Live Website, Resumes & LinkedIn Header
