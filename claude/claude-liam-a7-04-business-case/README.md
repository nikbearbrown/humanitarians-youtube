...
# The Business Case: Model, GTM, Competition + Ask (Slides 5–7, 10)

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 7 — BUSINESS CASE (E4/7)

This is Humanitarians.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 7 brief — Video Pitch to Investors: Slides 5–7, 10 (business model, GTM, competition, ask)
