...
# Brand Foundation: Mission, Purpose, Vision, Values + a UVP You'd Say Out Loud

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 6 — BRAND FOUNDATION (E1/7)

This is Liam for Humanitarians AI.

The current plan contains **9 beats**. Its runtime is derived from 9 beats. The source recorded by the project is: INFO 7375 Assignment 6 brief — Brand Strategy + Naming
