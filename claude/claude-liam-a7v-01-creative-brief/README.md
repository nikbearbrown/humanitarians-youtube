...
# The Creative Brief: 6 Fields That Drive Everything

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 7 (VISUAL) — CREATIVE BRIEF (E1/6)

This is Humanitarians.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 7 (Visual) brief — creative brief from A6, visual identity components, wireframes; due 2026-07-17
