...
# Mood Board + Style Guide: Palette, Fonts, and Rules

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 7 (VISUAL) — MOOD BOARD + STYLE GUIDE (E3/6)

This is Kore for Humanitarians AI.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 7 (Visual) brief — mood board, Coolors palette, Google Fonts, style guide; due 2026-07-17
