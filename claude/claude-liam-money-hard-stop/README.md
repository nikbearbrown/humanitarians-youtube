...
**Topic:** THE MONEY HARD-STOP RULE

This is Kore for Humanitarians AI.

The current plan contains **12 beats**. Its runtime is derived from 12 beats. The source recorded by the project is: Bear Brown house rule (AGENTS.md HARD STOP money rule); Vercel MCP security docs verified 2026-07-18
