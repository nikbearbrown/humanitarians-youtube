...
**Topic:** BUILD WITH CLAUDE · ANTHROPIC

This is Liam for Humanitarians AI.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: Anthropic Cookbooks — Metaprompt: Generate Prompts from Task Descriptions
