...
# Build the Weekly Operations Packet with Claude: Capstone Demo
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: claude-cowork/chapters/12-capstone-the-weekly-operations-packet.md
