...
**Topic:** Talk analysis: Lamis Mukta's 'Learning while you sleep: Beyond memory to dreaming' — context engineering as an intelligence multiplier, the year of simple memory primitives, four…

Merhaba — this is Liam, in for Bear. Today's source is a conference talk: Lamis Mukta, of Anthropic's applied AI team, at AI Native DevCon in London — on why agent memory shouldn't stop at remembering. Her claim: give your fleet a second, slower loop — and let your agents dream. Let's tear down what that means.

The current plan contains **45 beats**. Its runtime is 598.2. The source recorded by the project is: Lamis Mukta (Anthropic, Applied AI), 'Learning while you sleep: Beyond memory to dreaming', AI Native DevCon, London, June 2026 — https://www.youtube.com/watch?v=tTcxVv8HHNw — full timestamped transcript on disk as SOURCE.md in this folder
...
5. **Generate local audio:** use Kokoro voice `am_onyx` in the Teardown register. Measured audio durations become the master clock; never repair timing by hand.
