...
# Why the safer training objective gets the fewest rounds of refinement

## What this video is about

**Topic:** Asymmetric iteration between the helpfulness and harmlessness data pipelines

The README states helpfulness spans three tranches (base, rejection-sampled, online) while harmlessness is "only collected for our base models."

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/hh-rlhf/README.md`
