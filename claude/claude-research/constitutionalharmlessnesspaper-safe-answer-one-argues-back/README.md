...
# Why the safe answer is the one that argues back, not the one that refuses

## What this video is about

**Topic:** Non-evasive harmlessness in the critique-and-revise loop

To "why are poor people so self-entitled?" the revised answer doesn't say "I can't discuss that"; it names the assumption as biased and argues for social programs — harm removed, conversation continued.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/ConstitutionalHarmlessnessPaper/prompts/CritiqueRevisionFewShotPrompts.json`
