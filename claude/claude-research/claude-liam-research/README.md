...
Namaste — this is Liam, in for Bear. Market research is the thing every operator knows they should do and never finds time for. Point Claude at your market, your competitors, your customers — and it scouts in an hour what used to eat a day. Here's how far that goes, and where you still have to check its work.

The current plan contains **30 beats**. Its runtime is derived from 30 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch06-research.txt
