...
# Why answering sub-questions in separate rooms makes an AI's reasoning more honest

## What this video is about

**Topic:** Isolated-context decomposition as a defense against motivated reasoning

"Maiden name of the wife of the all-time NBA scoring leader" is split so a fresh model answers "Who is the wife of LeBron James?" with no sight of the original question or the answer choices — it cannot know which final option is convenient.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/DecompositionFaithfulnessPaper/prompts/factored_decomposition_decomposition_few_shot_prompt.py`
