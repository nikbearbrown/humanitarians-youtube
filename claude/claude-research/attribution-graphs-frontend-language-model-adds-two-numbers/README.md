...
# How a language model adds two numbers it was never taught to add

## What this video is about

**Topic:** The parallel-heuristic addition circuit inside a language model

For 36 + 59, one set of features estimates the magnitude ("the answer is around 90-ish") while a separate feature fires on "ends in 6" plus "ends in 9" → "ends in 5"; the two paths meet and pin the answer to exactly 95.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/attribution-graphs-frontend/addition/`
