...
# Build the AI-Use Log Habit with Claude
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: claude/chapters/07-research-writing-and-analysis-workflows.md
