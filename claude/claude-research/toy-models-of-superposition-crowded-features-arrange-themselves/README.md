...
# Why crowded features arrange themselves into perfect pentagons

## What this video is about

**Topic:** The geometry features adopt when forced to share dimensions

Five equally-important features forced through a 2-D bottleneck at high sparsity settle as a regular pentagon — five unit vectors 72° apart — not a random scatter.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/toy-models-of-superposition/toy_models.ipynb`
