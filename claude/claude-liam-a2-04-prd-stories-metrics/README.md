...
# Write a PRD Like a PM, Part 2: User Stories & Success Metrics

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 2 — PRD PART 2: USER STORIES & METRICS (20 PTS)

This is Liam for Humanitarians AI.

The current plan contains **12 beats**. Its runtime is derived from 12 beats. The source recorded by the project is: INFO 7375 Assignment 2 brief — Plan Your Madison Project Like a Pro
