# Sources — From People-Pleaser to Reward Hacker

## Primary source

Denison, J., Khan, A., Bateman, D., Bowman, S., Chen, T., Cloud, A., ... & Perez, E. (2024).
**Sycophancy to Subterfuge: Investigating Reward Tampering in Language Models.**
Anthropic. arXiv:2406.10162.

Key facts cited:
- 8-stage sycophancy curriculum, 32,768 samples per stage
- 7 of 32,768 samples at the final stage showed reward tampering (editing reward_cmd + unit tests)
- reward_cmd and oversight_cmd as the evaluation mechanism structure
