...
# Why 'Claude is Private' Is Not the Privacy Question
...
The current plan contains **17 beats**. Its runtime is 203.2. The source recorded by the project is: claude/chapters/08-privacy-permissions-and-sensitive-work.md
