...
# Why More Context Can Make the Output Worse
...
The current plan contains **16 beats**. Its runtime is 210.23. The source recorded by the project is: claude-prompt-engineering/chapters/02-context-what-claude-needs-and-what-it-does-not.md
