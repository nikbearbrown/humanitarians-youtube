...
# Ship It: Three Canvas Submissions

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 5B — SHIP IT (E6/6)

This is Humanitarians.

The current plan contains **8 beats**. Its runtime is derived from 8 beats. The source recorded by the project is: INFO 7375 Assignment 5B brief — Nik's Recipe-Based Framework
