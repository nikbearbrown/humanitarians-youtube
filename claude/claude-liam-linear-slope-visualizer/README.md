...
# Build a Slope Visualizer with Claude Code
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: college-algebra-bundle-with-llms/chapters/ch03_linear_equations.md
