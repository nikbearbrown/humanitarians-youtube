...
# Build a Volatility Drag Simulator with Claude Code
...
The current plan contains **11 beats**. Its runtime is 108. The source recorded by the project is: computational-finance-with-ai/chapters/02-returns-and-risk-measurement.md
