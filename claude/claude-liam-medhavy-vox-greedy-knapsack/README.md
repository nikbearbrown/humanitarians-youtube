...
# Why Greedy Can Guarantee Half the Optimal Knapsack
...
The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: youtubers/chapters/approximation-algorithms-greedy-never-wins-less-than-half.md
