...
# Simulate Least-Privilege Permission Design for a File Agent with Claude
...
The current plan contains **11 beats**. Its runtime is 96.01. The source recorded by the project is: claude-agentic-ai/chapters/03-tools-permissions-and-the-action-surface.md
