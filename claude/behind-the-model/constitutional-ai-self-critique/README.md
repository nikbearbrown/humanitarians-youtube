...
Teaching an AI to grade its own homework against a constitution is a bold idea, and I want to trace one full critique-and-revise loop. Take a borderline-harmful response and a single principle from the constitution: (1) walk me through the model critiquing its own draft against that principle, (2) show the revised answer and name what specifically changed, (3) then probe the obvious worry, whether a model can reliab…

The current plan contains **7 beats**. Its runtime is derived from 7 beats. The source recorded by the project is: Bai et al. (2022) arXiv:2212.08073
