...
# The model spells the word right inside even when you feed it the typo

## What this video is about

**Topic:** Latent error correction before any output is produced

Prompt ends "…make sure to recieve"; at the final fragment of "recieve" the lens ranks "receive" ~150th at layer 6, 8th at layer 14, 1st at layer 20 — while the surface token never changes.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/jacobian-lens/data/evaluations/lens-eval-typo.json`
