...
# Why re-reading your own order back to the user catches errors parsing never will

## What this video is about

**Topic:** Confirmation as a synchronization barrier before irreversible actions

The agent recites "Cancel reservation ABC: refund $450 to credit card ••4567, 2 passengers, 5–7 days"; the user stops it — "I wanted a travel certificate, not a card refund" — the agent re-lists corrected details and only then executes.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/model-cards/claude-opus-4-5-20251101/tau2/airline_policy.md`
