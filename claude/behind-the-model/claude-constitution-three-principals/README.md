...
# Claude's Three Bosses

## What this video is about

**Topic:** AI DESIGN · The Principal Hierarchy

The idea that Claude answers to three ranked principals — Anthropic, the operator, and the end user — makes me wonder what happens when their instructions collide. I want to trace the conflict resolution concretely. Help me: (1) construct a scenario where an operator's system prompt asks for something the user's request contradicts, and say who wins; (2) explain why the top principal's rules can't simply be overridd…

The current plan contains **7 beats**. Its runtime is derived from 7 beats. The source recorded by the project is: Anthropic Model Spec / Claude Constitution (2026)
