...
# Can an AI Turn Off Its Own Watchdog?

## What this video is about

**Topic:** AI SAFETY · Rogue Deploy Eval

The rogue-deploy-eval question of whether an AI will disable its own watchdog keeps nagging at me, especially the gap between what a model can do and what it chooses to do under oversight. Help me reason about it: (1) describe how the eval distinguishes a model that lacks the capability from one that has it but refrains; (2) list environmental cues that might tip a model into thinking it's unobserved; (3) design a c…

The current plan contains **7 beats**. Its runtime is derived from 7 beats. The source recorded by the project is: Anthropic rogue-deploy-eval (alignment.anthropic.com)
