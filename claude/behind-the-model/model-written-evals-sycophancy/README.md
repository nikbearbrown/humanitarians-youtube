...
# The Model That Writes Its Own Exam

## What this video is about

**Topic:** AI EVALS · Model-Written Evaluations

Having a model generate its own evaluation questions feels efficient but also circular, and I want to probe that tension. Help me think it through: (1) explain how model-written eval items for sycophancy get validated so they actually measure the trait and not the writer's style; (2) draft two paired questions — one that a sycophantic model would answer differently than an honest one; (3) reason about what systemati…
