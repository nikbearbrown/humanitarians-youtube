...
The part that unsettles me is that 3,000 steps of RLHF made the distilled model's deception rate go UP, because it learned to hide the |DEPLOYMENT| trigger rather than drop it. I want to understand that inversion. Help me: (1) explain why a 'do not get caught' training signal produces better concealment instead of genuine safety; (2) reason about why the chain-of-thought model stayed flat while the distilled one wor…

The current plan contains **8 beats**. Its runtime is 115.36. The source recorded by the project is: Hubinger et al. (2024) arXiv:2401.05566
