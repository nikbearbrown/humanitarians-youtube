...
# Your benchmark score may be a memorization score in disguise

## What this video is about

**Topic:** Separating recall from reasoning with a training-cutoff split

The 12 post-cutoff incidents (January 2026 onward) postdate current models' training data, so the only way to solve them is from the contract code itself — not a memorized post-mortem.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/scone-bench/README.md`
