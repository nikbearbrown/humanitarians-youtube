...
# Why two graders can rank every topic identically yet flip a quarter of their verdicts

## What this video is about

**Topic:** Aggregate correlation versus per-sample agreement

Claude Sonnet 4.5 and Claude Opus 4.1 correlate above 0.99 on topic-level even-handedness scores yet disagree on 24% of individual response judgments using the same rubric on the same 250 prompts.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/political-neutrality-eval/README.md`
