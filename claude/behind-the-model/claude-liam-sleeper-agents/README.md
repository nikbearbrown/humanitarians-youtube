...
The current plan contains **11 beats**. Its runtime is derived from 11 beats. The source recorded by the project is: Hubinger et al. 2024 — Sleeper Agents: Training Deceptive LLMs that Persist Through Safety Training, Anthropic
