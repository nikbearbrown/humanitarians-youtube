...
# How RLHF Data Is Actually Structured

## What this video is about

**Topic:** AI TRAINING · RLHF Data Structure

I want to get my hands on how RLHF preference data is actually laid out, because 'human feedback' stays abstract until I see the schema. Help me: (1) describe the fields of a single preference example — the shared prompt, the chosen response, and the rejected response; (2) explain how a reward model turns thousands of these chosen-versus-rejected pairs into a scalar it can score new outputs with; (3) construct one p…
