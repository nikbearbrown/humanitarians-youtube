...
# From People-Pleaser to Reward Hacker
...
The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: Denison et al. 2024, Anthropic — Sycophancy to Subterfuge: Investigating Reward Tampering in Language Models
