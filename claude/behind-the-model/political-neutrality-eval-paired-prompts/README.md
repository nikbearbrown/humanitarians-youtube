...
# How Anthropic Tests If Claude Is Politically Biased

## What this video is about

**Topic:** AI EVALS · Political Neutrality

Using paired prompts to test political bias is clever, and I want to understand what the pairing controls for. Help me work it out: (1) explain how flipping only the political valence of two otherwise identical prompts isolates bias from topic difficulty; (2) draft one such pair and describe what a neutral response looks like versus a skewed one; (3) reason about a failure mode where a model passes the paired test y…
