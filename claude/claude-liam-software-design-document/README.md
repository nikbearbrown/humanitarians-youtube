...
# Write a Five-Artifact Software Design Document with Claude Code
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: claude-code-for-students/chapters/07-software-design-document.md
