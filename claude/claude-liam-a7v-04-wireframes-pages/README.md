...
# Five-Page Desktop Wireframes in Figma

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 7 (VISUAL) — WIREFRAMES (E4/6)

This is Liam for Humanitarians AI.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 7 (Visual) brief — 5 desktop wireframes in Figma; due 2026-07-17
