...
# Pitch Like Kawasaki: 10 Slides, 8 Minutes, 30-Point Font

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 7 — THE PITCH ARC (E1/7)

This is Liam for Humanitarians AI.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 7 brief — Video Pitch to Investors: the arc, Kawasaki 10/20/30, and 80/20 philosophy
