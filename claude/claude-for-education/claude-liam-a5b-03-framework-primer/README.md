...
# Four Layers, Five Hard Stops: The Framework

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 5B — FRAMEWORK PRIMER (E3/6)

This is Kore for Humanitarians AI.

The current plan contains **9 beats**. Its runtime is derived from 9 beats. The source recorded by the project is: INFO 7375 Assignment 5B brief — Nik's Recipe-Based Framework
