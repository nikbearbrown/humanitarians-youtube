...
Merhaba — this is Kore, in for Humanitarians AI. You are working with the math-olympiad skill. It solves competition math — IMO, Putnam, USAMO, AIME — with adversarial verification that catches what self-verification misses. The philosophy: check the interpretation before solving anything, strip the thinking trace before any verifier sees it, use pattern-armed attacks rather than generic checking, and say no confide…
