...
# Name the Human: User + Problem + 3 Stories

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 5 — USER + STORIES (E2/7)

This is Humanitarians.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 5 brief — The Conductor Brief: Part 2 (16 pts)
