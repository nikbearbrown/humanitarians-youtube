...
# Write the Recipe: The Conductor's Score

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 5B — WRITE RECIPE (E4/6)

This is Humanitarians.

The current plan contains **11 beats**. Its runtime is derived from 11 beats. The source recorded by the project is: INFO 7375 Assignment 5B brief — Nik's Recipe-Based Framework
