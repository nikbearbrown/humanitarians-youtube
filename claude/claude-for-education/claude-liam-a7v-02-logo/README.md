...
# Logo: 4–5 Concepts + the Rationale

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 7 (VISUAL) — LOGO (E2/6)

This is Humanitarians.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 7 (Visual) brief — logo concepts and rationale; due 2026-07-17
