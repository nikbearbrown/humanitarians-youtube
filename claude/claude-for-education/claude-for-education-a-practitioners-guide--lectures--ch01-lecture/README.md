...
This video explains chapter 1: what claude can and cannot do in education through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/01-what-claude-can-and-cannot-do-in-education.md
