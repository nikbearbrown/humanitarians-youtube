...
# Record It: Zoom (fast) vs Remotion/Brutalist (standout)

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 7 — RECORD IT (E6/7)

This is Kore for Humanitarians AI.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 7 brief — Video Pitch to Investors: recording the pitch (Zoom path vs Remotion/Brutalist path)
