...
The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: Anthropic Prompt Engineering Interactive Tutorial — Lesson 03: Role Prompting
