...
This video explains chapter 1 — the homework/quiz gap: what's actually happening through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/01-homework-quiz-gap.md
