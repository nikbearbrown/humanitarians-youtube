...
# Chapter 10 — Student Use: From Ban to Boundary

## What this video is about

**Topic:** Claude For Education

This video explains chapter 10 — student use: from ban to boundary through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/10-student-use-from-ban-to-boundary.md
