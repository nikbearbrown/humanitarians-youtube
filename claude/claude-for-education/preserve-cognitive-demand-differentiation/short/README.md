...
**Topic:** Preserve Cognitive Demand Differentiation

Hola, I'm Liam — in for Bear. Every differentiation strategy has a hidden trap. When you make the task easier for the students who are struggling, you quietly rob them of the very thinking you're trying to build. Today we look at a better principle: same hard case, different door in.

The current plan contains **9 beats**. Its runtime is 155.13. The source recorded by the project is: See the local source and fact-check files.
