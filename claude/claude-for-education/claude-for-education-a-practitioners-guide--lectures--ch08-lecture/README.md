...
# Chapter 8 — Assessment in the Age of Claude

## What this video is about

**Topic:** Claude For Education

This video explains chapter 8 — assessment in the age of claude through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/08-assessment-in-the-age-of-claude.md
