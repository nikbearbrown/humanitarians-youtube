...
Olá, I'm Liam — in for Bear. The CRA progression is one of the most research-backed tools in math education: Concrete first, then Representational, then Abstract. But most teachers use it sequentially across days or weeks. Today's insight: you can run all three rungs in the same lesson by setting different entry points per tier.
