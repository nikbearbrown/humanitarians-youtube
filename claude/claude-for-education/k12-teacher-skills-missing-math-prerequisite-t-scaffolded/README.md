...
# Why a missing math prerequisite can't be scaffolded around — only routed through

## What this video is about

**Topic:** Math knowledge compounding and the prerequisite-gap mechanism

A 6th grader meets ratio reasoning. The teacher adds double number lines, ratio tables, sentence supports. Nothing moves. The real gap is 5th-grade fraction equivalence — the scaffolds have nothing to attach to.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/k12-teacher-skills/plugin/skills/k12-lesson-differentiation/references/math.md`
