...
# Same Text, Better Scaffold

## What this video is about

**Topic:** Access Scaffolding Text Substitution

Merhaba, I'm Liam — in for Bear. In ELA, the differentiation trap has a specific name: text substitution. A student struggles with the grade-level reading, so you give them an easier book. Problem solved — until you realise you've just locked them out of the grade-level conversation. Today's principle: same text, different support structure.

The current plan contains **9 beats**. Its runtime is 169.3. The source recorded by the project is: See the local source and fact-check files.
