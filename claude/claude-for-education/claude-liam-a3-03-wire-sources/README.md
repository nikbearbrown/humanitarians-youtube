...
# Build the Pipeline, Part 1: Wire Up Your 3 Sources

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 3 — WIRE 3 SOURCES (E3/7)

This is Humanitarians.

The current plan contains **11 beats**. Its runtime is derived from 11 beats. The source recorded by the project is: INFO 7375 Assignment 3 brief — Shop for Ingredients: Collect Your Madison Data
