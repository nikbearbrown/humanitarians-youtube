...
# Seven Fields That Make a Task Brief

## What this video is about

**Topic:** TASK BRIEFS · COWORK

This is Liam for Humanitarians AI.

The current plan contains **10 beats**. Its runtime is 92. The source recorded by the project is: See the local source and fact-check files.
