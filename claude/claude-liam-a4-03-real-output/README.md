...
# Complete the Loop: Turn JSON into Something a Human Can Use

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 4 — REAL OUTPUT (E3/7)

This is Humanitarians.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 4 brief — Scale Your Thing & Add Intelligence
