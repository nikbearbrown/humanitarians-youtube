...
**Topic:** EXAMPLE COMMAND · CLAUDE PLUGINS

Olá — this is Liam, in for Bear. You are building a slash command for Claude — the example-command skill is the reference template. It lives at skills slash name slash SKILL.md and shows the complete frontmatter schema: five fields, an argument injection point, and the three-step body pattern. It is not a working skill — it is the format. Let me walk you through what it demonstrates and where the gaps are.
