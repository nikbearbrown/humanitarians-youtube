...
# Why "copyright restrictions" can mean three completely different things

## What this video is about

**Topic:** Moderation opacity; diagnosing aliased error messages

A prompt fails on "copyright restrictions." Remove the brand name — still fails. Change the verb — still fails. Remove the last detail — passes. Three rules fired across three attempts; the error string never changed.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-plugins-community/quickdesign/skills/quickdesign/references/brand-and-moderation.md`
