...
Bonjour — this is Liam, in for Bear. Installing a Cowork plugin is trivial: browse, click, done. The real work — and the real payoff — is teaching it your business. Here's where the leverage actually lives.

The current plan contains **32 beats**. Its runtime is derived from 32 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch02-installing-customizing.txt
