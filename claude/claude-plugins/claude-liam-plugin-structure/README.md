...
Merhaba — this is Kore, in for Humanitarians AI. You are working with the plugin-structure skill. It documents how a Claude Code plugin is laid out — the directory tree, the manifest, the five component types, and the portable path system. Three rules govern everything. First: the manifest goes in dot-claude-plugin slash plugin dot json — not in the component directories. Second: the component directories — commands…
