...
**Topic:** CONFIG GUIDE · CLAUDE TAG PLUGIN

Merhaba — this is Liam, in for Bear. Ask how to set up at-Claude, how agents or agent scopes work, how configuration inherits across a workspace, or how to add a GitHub repo or connection — and the Config Guide skill fires. This is an index skill: it does not answer directly from its own content, but routes to five short reference files based on what the user is asking. It is currently scoped to Slack only. Let me w…
