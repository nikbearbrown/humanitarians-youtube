...
**Topic:** CARDPUTER BUDDY · CLAUDE PLUGIN

Hola — this is Liam, in for Bear. Ask Claude to add an app to the Cardputer, push a changed file without re-flashing, watch device serial logs, or run a one-shot REPL command — the Cardputer Buddy skill fires. It is the iterate-after-provisioning skill: m5-onboard handles the first install, this skill handles everything after. Let me walk you through the device layout, the launcher auto-discovery, and the three dev-…
