...
Hola — this is Kore, in for Humanitarians AI. Ask Claude to add an app to the Cardputer, push a changed file without re-flashing, watch device serial logs, or run a one-shot REPL command — the Cardputer Buddy skill fires. It is the iterate-after-provisioning skill: m5-onboard handles the first install, this skill handles everything after. Let me walk you through the device layout, the launcher auto-discovery, and th…
