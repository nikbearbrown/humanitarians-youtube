...
Sawubona — this is Kore, in for Humanitarians AI. Install more than one plugin and you never have to say which. Claude reads the request and reaches for whatever fits. The real power was never one plugin. It's the stack.
