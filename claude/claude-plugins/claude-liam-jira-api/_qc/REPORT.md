...
|------|------|--------|--------|
| B00 | 14.5s | ClaudeComposerAsk — "Merhaba, Liam"; JIRA API · CLAUDE PLUGINS; correct command + output lines | PASS |
...
| BOUT | 422.3s | ClaudeTitleOutro — "jira api. @NikBearBrown. jira api · Claude Plugins" | PASS |
