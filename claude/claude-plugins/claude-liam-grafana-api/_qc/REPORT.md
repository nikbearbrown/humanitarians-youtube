...
|------|------|--------|--------|
| B00 | 10.5s | ClaudeComposerAsk — "Merhaba, Kore", correct topic/output lines (three time formats, two alert surfaces, datasource error) | PASS |
...
| BOUT | 353.0s | ClaudeTitleOutro — "grafana-api. @HumanitariansAI. grafana-api · Claude Plugins" | PASS |
