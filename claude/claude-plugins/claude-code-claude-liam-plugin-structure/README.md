...
Guten Tag — this is Kore, in for Humanitarians AI. Ask Claude to create a plugin, scaffold a plugin structure, understand directory layout, set up plugin.json, or organize plugin components — the Plugin Structure skill fires. Claude Code plugins follow a standardized layout: a manifest in the dot-claude-plugin directory, and component directories — commands, agents, skills, hooks — at the plugin root. Auto-discovery…
