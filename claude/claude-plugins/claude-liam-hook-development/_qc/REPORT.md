...
|------|------|--------|--------|
| B00 | 10.7s | ClaudeComposerAsk — "Merhaba, Kore"; HOOK DEVELOPMENT · CLAUDE PLUGINS; correct command + output lines | PASS |
...
| BOUT | 321.1s | ClaudeTitleOutro — "hook development. @HumanitariansAI. hook development · Claude Plugins" | PASS |
