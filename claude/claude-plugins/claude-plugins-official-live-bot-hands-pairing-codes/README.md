...
# Why a live bot hands pairing codes to strangers, then suddenly stops

## What this video is about

**Topic:** Access control via pairing state machine

Discord bot launches. Strangers DM it; the bot replies with a 6-character code. You DM your own bot, get `ABC123`, run `/discord:access pair ABC123` in Claude. The bot switches to allowlist mode and stops accepting pairing codes entirely.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-plugins-official/external_plugins/discord/README.md`
