...
|------|------|--------|--------|
| B00 | 12.3s | ClaudeComposerAsk — "Merhaba, Liam"; LINEAR API · CLAUDE PLUGINS; ENG team command + 3 output lines | PASS |
...
| BOUT | 372.4s | ClaudeTitleOutro — "linear api. @NikBearBrown. linear api · Claude Plugins" | PASS |
