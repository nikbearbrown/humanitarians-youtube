...
# Why an image model's burned-in captions hallucinate but an ASR endpoint's don't

## What this video is about

**Topic:** Subtitle accuracy; when to offload to specialized tools

A prompt renders "beutiful product" over audio that says "beautiful product." Rerun through a dedicated subtitle endpoint and every word matches at word-level timing.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-plugins-community/quickdesign/skills/quickdesign/references/auto-subtitle.md`
