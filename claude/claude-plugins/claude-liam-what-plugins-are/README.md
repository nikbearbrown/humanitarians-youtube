...
Hola — this is Liam, in for Bear. Install a plugin and Claude stops being a clever generalist and becomes an equipped specialist. Here's what that actually means, and where the line is.

The current plan contains **27 beats**. Its runtime is derived from 27 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch01-what-plugins-are.txt
