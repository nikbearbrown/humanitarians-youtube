...
Hej — this is Liam, in for Bear. The official plugins cover the common jobs. But your work has a shape no catalog anticipated — and when none of them fit, you can build your own. Here's how it works, and here's the one discipline that keeps it honest.

The current plan contains **34 beats**. Its runtime is derived from 34 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch12-building-your-own.txt
