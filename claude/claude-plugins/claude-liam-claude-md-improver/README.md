...
Salut — this is Kore, in for Humanitarians AI. Ask Claude to check, audit, update, improve, or fix CLAUDE.md files — or mention CLAUDE.md maintenance — and the Claude MD Improver fires. It is a full read-write skill: it discovers all CLAUDE.md files across five locations, scores each against a six-criterion rubric, outputs a quality report, and then makes targeted improvements after approval. Let me walk you through…
