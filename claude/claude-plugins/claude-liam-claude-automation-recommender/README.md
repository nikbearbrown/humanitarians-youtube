...
**Topic:** CLAUDE AUTOMATION RECOMMENDER · CLAUDE PLUGIN

Bonjour — this is Liam, in for Bear. Ask Claude for automation recommendations, ask how to optimize your Claude Code setup, or ask what Claude Code features you should use — the Claude Automation Recommender skill fires. It is a read-only analysis skill: it scans your codebase for signals, then recommends tailored automations across all five Claude Code extensibility types. It never creates files — you implement the…
