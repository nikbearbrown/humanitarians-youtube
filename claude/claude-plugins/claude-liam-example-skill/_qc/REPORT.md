...
|------|------|--------|--------|
| B00 | 10.5s | ClaudeComposerAsk — "Merhaba, Kore" cold open; greeting correct, output lines correct | PASS |
...
| BOUT | 278.3s | ClaudeTitleOutro — "example-skill. @HumanitariansAI. example-skill · Claude Plugins" | PASS |
...
- [x] Greeting "Merhaba, Kore" — correct for rotation #45
