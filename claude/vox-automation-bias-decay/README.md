...
# Why Automation Bias Gets Worse After a Run of Successes
...
The current plan contains **9 beats**. Its runtime is 80.99. The source recorded by the project is: claude-agentic-ai/chapters/09-failure-modes-of-agentic-work.md
