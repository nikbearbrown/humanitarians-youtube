...
# Audit an Agent's Action Surface Before Running a Task with Claude
...
The current plan contains **11 beats**. Its runtime is 91.32. The source recorded by the project is: claude-agentic-ai/chapters/03-tools-permissions-and-the-action-surface.md
