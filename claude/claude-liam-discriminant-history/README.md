...
# The History of the Discriminant with Claude
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: college-algebra-bundle-with-llms/chapters/ch05_quadratic_functions.md
