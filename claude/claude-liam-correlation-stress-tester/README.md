...
# Stress-Test a Two-Asset Portfolio Correlation with Claude Code
...
The current plan contains **11 beats**. Its runtime is 108. The source recorded by the project is: computational-finance-with-ai/chapters/08-the-diversification-miracle.md
