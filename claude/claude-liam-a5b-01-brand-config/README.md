...
# The brand_config.json: Your Brief as Machine-Readable JSON

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 5B — BRAND CONFIG (E1/6)

This is Kore for Humanitarians AI.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 5B brief — Nik's Recipe-Based Framework
