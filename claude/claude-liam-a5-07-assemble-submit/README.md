...
# Assemble & Ship the Brief

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 5 — ASSEMBLE + SUBMIT (E7/7)

This is Humanitarians.

The current plan contains **9 beats**. Its runtime is derived from 9 beats. The source recorded by the project is: INFO 7375 Assignment 5 brief — The Conductor Brief: all parts, assembly and submission
