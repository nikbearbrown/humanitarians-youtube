...
# Why the Wrong AI Surface Costs More Than the Wrong Prompt
...
The current plan contains **17 beats**. Its runtime is 194.76. The source recorded by the project is: claude/chapters/00-the-claude-ecosystem.md claude/chapters/01-the-work-chooses-the-tool.md
