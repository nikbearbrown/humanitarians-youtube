...
# Build a Privacy Classification Scanner for Cowork Folders
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: claude/chapters/08-privacy-permissions-and-sensitive-work.md
