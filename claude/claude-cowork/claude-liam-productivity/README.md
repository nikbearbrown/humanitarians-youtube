...
Ciao — this is Liam, in for Bear. Most Cowork plugins specialize in a domain. One specializes in you — your tasks, your meetings, your inbox, your day. It's the one people install first and almost never turn off. Here's what it actually does, and why it earns that spot.

The current plan contains **34 beats**. Its runtime is derived from 34 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch03-productivity.txt
