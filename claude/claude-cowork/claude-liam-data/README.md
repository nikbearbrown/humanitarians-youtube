...
Olá — this is Liam, in for Bear. Somewhere on your drive is a spreadsheet you're a little afraid of. The data plugin opens it, cleans it, and answers the question you've been avoiding — in plain English. Here's how far that goes, and where you still hold the pen.

The current plan contains **33 beats**. Its runtime is derived from 33 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch07-data.txt
