...
Salaam — this is Kore, in for Humanitarians AI. A plugin misbehaves. A connection fails. Or the guide you're reading doesn't match your screen. The move isn't to chase the surface — it's to return to what the plugin is for, and check the official docs for what's true today.
