...
Salaam — this is Liam, in for Bear. A plugin misbehaves. A connection fails. Or the guide you're reading doesn't match your screen. The move isn't to chase the surface — it's to return to what the plugin is for, and check the official docs for what's true today.

The current plan contains **24 beats**. Its runtime is derived from 24 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch14-troubleshooting.txt
