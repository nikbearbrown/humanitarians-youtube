...
This video explains chapter 8 — organizing and renaming files through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/08-organizing-and-renaming-files.md
