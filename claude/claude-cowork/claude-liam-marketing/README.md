...
Hallo — this is Liam, in for Bear. Install the marketing plugin and Claude stops being a content vending machine and becomes a marketing collaborator — one that plans, analyzes, and refines, not just drafts. Here's what that buys you, and where the line is.

The current plan contains **32 beats**. Its runtime is derived from 32 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch04-marketing.txt
