...
Jambo — this is Liam, in for Bear. If you have customers, you have support — and it doesn't wait. Install the support plugin and Claude triages the queue, drafts on-brand replies, and turns the questions you keep answering into answers you write once. Here's how it works, and where you stay on the line.

The current plan contains **28 beats**. Its runtime is derived from 28 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch10-support.txt
