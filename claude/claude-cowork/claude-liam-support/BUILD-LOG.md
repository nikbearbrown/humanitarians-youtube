...
**Remotion patterns used (VR* series — all use CLAUDE tokens natively):**
  ...
  B05 (illustration/triage-three-lanes) → SlateCard (unregistered custom illustration — will render as slate in previz; needs Remotion component or pantry still before final cut).
  B07 (illustration/sentiment-flag) → SlateCard (unregistered custom illustration — will render as slate in previz; needs Remotion component or pantry still before final cut).
  B09 (illustration/connect-support-inbox) → SlateCard (unregistered custom illustration — will render as slate in previz; needs Remotion component or pantry still before final cut).
  B10 (illustration/configure-tone-escalation) → SlateCard (unregistered custom illustration — will render as slate in previz; needs Remotion component or pantry still before final cut).
  ...
  B20 (SparkBeat) → VRSegmentCard — already uses CLAUDE tokens (cream/ink/terracotta); no additional retint needed.
