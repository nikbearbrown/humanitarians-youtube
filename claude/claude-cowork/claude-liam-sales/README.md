...
Konnichiwa — this is Liam, in for Bear. Most people who reach for the sales plugin don't call themselves salespeople. It meets you where you are — it researches a prospect, preps the conversation, and drafts the follow-up. The closing stays yours.

The current plan contains **34 beats**. Its runtime is derived from 34 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch05-sales.txt
