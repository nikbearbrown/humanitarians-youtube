...
**Topic:** CLAUDE · COWORK PLUGINS

Merhaba — this is Liam, in for Bear. Ignore the name for a second — 'enterprise search' sounds like something a giant deploys across ten thousand people. But it earns its keep the moment knowledge is scattered across many tools and many people: the answer you need already exists, buried in someone's doc, a deck, a thread — and you can't reach it. This plugin points Claude at your own sources and finds it. Here's how…

The current plan contains **33 beats**. Its runtime is derived from 33 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch08-enterprise-search.txt
