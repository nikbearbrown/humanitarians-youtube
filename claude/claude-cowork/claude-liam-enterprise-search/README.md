...
Merhaba — this is Kore, in for Humanitarians AI. Ignore the name for a second — 'enterprise search' sounds like something a giant deploys across ten thousand people. But it earns its keep the moment knowledge is scattered across many tools and many people: the answer you need already exists, buried in someone's doc, a deck, a thread — and you can't reach it. This plugin points Claude at your own sources and finds it…
