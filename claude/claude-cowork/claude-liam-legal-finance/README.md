...
Shalom — this is Liam, in for Bear. Two plugins do the unglamorous work that keeps a small operation out of trouble: legal reads a contract before you sign it, finance runs the numbers before you commit. Here's what each one screens for — and exactly where each one stops.

The current plan contains **34 beats**. Its runtime is derived from 34 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch11-legal-finance.txt
