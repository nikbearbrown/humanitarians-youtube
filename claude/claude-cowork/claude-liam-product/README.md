...
Annyeong — this is Liam, in for Bear. You're building something: an app, a course, a membership site. The product plugin takes scattered feedback and analytics and turns them into a prioritized shortlist of what to build next. Here's how it works — and where it hands the decision back to you.

The current plan contains **34 beats**. Its runtime is derived from 34 beats. The source recorded by the project is: books/anthropics/books/claude-cowork-plugins/chapters/ch09-product.txt
