...
**Topic:** AI SAFETY/ALIGNMENT/EVALS · ANTHROPIC RESEARCH

This is Humanitarians.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: Perez et al. 2022 — Discovering Language Model Behaviors with Model-Written Evaluations, Anthropic
