...
# Why Claude Can't Write Your Literature Review
...
The current plan contains **15 beats**. Its runtime is 225.84. The source recorded by the project is: claude-prompt-engineering/chapters/07-prompts-for-research-and-literature-work.md
