...
|------|-----------|-------|--------|
| B00 | 5s | ClaudeComposerAsk — "Dia dhuit, Kore" + "Kore, in for Humanitarians AI." + command | PASS |
...
9. **BOUT** — "Claude, Generated." / @HumanitariansAI / "Kore, in for Humanitarians AI.": PASS
