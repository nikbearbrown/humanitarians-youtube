...
Ciao — this is Kore, in for Humanitarians AI. Ask Claude to migrate your codebase from Sonnet 4.0, Sonnet 4.5, or Opus 4.1 to Opus 4.5 — and the Opus 4.5 Migration skill fires. It does not migrate Haiku. It is a one-shot migration: search for model strings, update them across all four deployment platforms, remove an unsupported beta header, add the effort parameter, and summarize. Prompt adjustments for known Opus 4…
