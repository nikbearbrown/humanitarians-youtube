...
# Why adding one capability at a time changes what the same agent produces

## What this video is about

**Topic:** Capability emergence — tools, sub-agents, memory

"Brief three companies." Stage 0 (chat only) confidently invents growth figures; Stage 1 (tools on) looks the numbers up; Stage 2 (sub-agents on) spawns one researcher per company in parallel; Stage 3 (memory on) opens with "last time you flagged the profitability gap."

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/agent-sdk-workshop/01-guided-demo/README.md`
