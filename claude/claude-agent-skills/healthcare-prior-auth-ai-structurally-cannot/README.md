...
# Why the prior-auth AI that structurally cannot say "no" is the correct design

## What this video is about

**Topic:** Asymmetric decision-space design in clinical gatekeeping

A clear orthopedic request → APPROVE. An ambiguous oncology drug → PEND, not DENY. Human reviewers own the PEND queue and make every denial. No automated denial ever closes a case against a member.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/healthcare/plugins/healthcare/skills/prior-auth/README.md`
