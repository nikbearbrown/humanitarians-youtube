...
# Why a cheap-worker crew reads 9 papers for a third less — at identical quality

## What this video is about

**Topic:** Cost-optimal task decomposition

Summarize 9 papers. Frontier-only: $0.90. Hybrid: frontier coordinator plans ($0.05), 3 cheap workers each read 3 papers ($0.15 each), frontier synthesizes ($0.10) = $0.60. A quality grader scores both 8.7/10.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-cookbooks/managed_agents/README.md`
