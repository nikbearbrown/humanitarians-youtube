...
# Why an untrusted document's hidden instructions never reach the write tool

## What this video is about

**Topic:** Compartmentalizing untrusted input through tiered tool access

The reconciler processes counterparty and custodian statements that may carry adversarial payloads designed to create false ledger entries.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/financial-services/managed-agent-cookbooks/gl-reconciler/README.md`
