...
# Why swapping in the "fast" model made the whole pipeline slower

## What this video is about

**Topic:** Extraction-quality feedback loops in multi-document pipelines

The measured 500-doc benchmark: opus finishes in 389s (0.2% rescue rate); haiku finishes in 590s (26% rescue rate). The cheap model costs more total because its misses trigger reader-agent rescue passes whose latency exceeds the per-doc inference savings.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/healthcare/plugins/healthcare/skills/contracts/README.md`
