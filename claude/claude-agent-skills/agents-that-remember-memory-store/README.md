...
# Why Agents Forget — And the Memory Store That Fixes It

## What this video is about

**Topic:** Claude Agent Skills

Same agent. Same person. You tell it something in one session — your coding style, your stack, your preferences. Ask the same thing in the next session: nothing. This is Liam, in for Bear.

The current plan contains **11 beats**. Its runtime is derived from 11 beats. The source recorded by the project is: agents-that-remember/ — Code with Claude 2026 Workshop W3
