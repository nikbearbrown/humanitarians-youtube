...
# Why one context flag flips every legal position to its mirror image

## What this video is about

**Topic:** Playbook polarity reversal in contract review

A vendor MSA arrives. Customer-side: push the vendor to indemnify you, raise the cap, grant a broad IP license. Vendor-side on the identical clause: resist each one.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-for-legal/commercial-legal/README.md`
