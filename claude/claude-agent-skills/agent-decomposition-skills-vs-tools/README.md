...
A 402-line system prompt with 12 tools is slow and expensive. A 15-line prompt with the same knowledge split into skills runs faster — and gets better answers. This is Kore, in for Humanitarians AI.
