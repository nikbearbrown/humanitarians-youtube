...
A 402-line system prompt with 12 tools is slow and expensive. A 15-line prompt with the same knowledge split into skills runs faster — and gets better answers. This is Liam, in for Bear.

The current plan contains **11 beats**. Its runtime is derived from 11 beats. The source recorded by the project is: agent-decomposition/ — Code with Claude 2026 Workshop W5
