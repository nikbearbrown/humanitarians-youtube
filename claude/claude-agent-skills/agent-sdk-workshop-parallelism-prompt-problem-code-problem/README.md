...
# Why parallelism is a prompt problem, not a code problem

## What this video is about

**Topic:** Prompt-driven concurrency in multi-agent orchestration

Briefing five companies. "Research each in turn" runs five sequential turns; "spawn one researcher per company in the same turn" runs all five at once — identical SDK code, one changed phrase.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/agent-sdk-workshop/docs/FAQ.md`
