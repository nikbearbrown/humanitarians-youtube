...
# Why cutting a 402-line agent prompt in half — while keeping every fact — makes it faster and better

## What this video is about

**Topic:** Decomposing a monolith prompt into tools, skills, and code execution

A daily low-stock sweep made 102 tool calls over 488 seconds; after splitting knowledge into on-demand skills and switching to code execution, the same task runs as 3 bash scripts in ~100 seconds — same correctness, far fewer tokens.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/cwc-workshops/agent-decomposition/`
