...
# Why "no family history of PE" needs three axes to mean anything

## What this video is about

**Topic:** Decomposing clinical findings into auditable dimensions

A note reads "family history of asthma" and "patient denies current cough." Both collapse to `null` unless you track who experienced what — presence + temporality + experiencer.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/healthcare/plugins/healthcare/skills/clinical-note-extract/`
