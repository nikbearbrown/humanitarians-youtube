...
# Why interleaved parallel tool logs can still be traced to the right agent

## What this video is about

**Topic:** Reconstructing which subagent made which call

Lead spawns 3 Researchers (each calling WebSearch repeatedly) plus a Data Analyst running Bash; calls stream past with no obvious owner.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-agent-sdk-demos/research-agent/README.md`
