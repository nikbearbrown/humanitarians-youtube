...
# Agent Development (Prose Triggers)

## What this video is about

**Topic:** AGENT DEVELOPMENT · CLAUDE CODE PLUGIN

Konnichiwa — this is Liam, in for Bear. Ask Claude to create an agent, add a subagent, write agent frontmatter, or get guidance on triggering conditions — the Agent Development skill fires. Agents are autonomous subprocesses that handle complex, multi-step tasks independently. They live in a markdown file with YAML frontmatter — name, description, model, color, tools — and a system prompt body. The description field…
