...
# What Bad Looks Like: The GIGO Layer + When to Hard Stop

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 5 — GIGO + HARD STOP (E5/7)

This is Kore for Humanitarians AI.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 Assignment 5 brief — The Conductor Brief: Part 5 (12 pts)
