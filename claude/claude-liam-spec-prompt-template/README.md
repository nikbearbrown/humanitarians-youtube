...
# Build a Specification Prompt Template for Student Assignments with Claude Code
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: claude-code-for-teachers/chapters/04-prompts-to-specifications.md
