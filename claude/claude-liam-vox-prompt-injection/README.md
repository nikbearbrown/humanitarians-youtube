...
# Why the Document You Asked AI to Read Might Be Giving It New Instructions
...
The current plan contains **18 beats**. Its runtime is 206.25. The source recorded by the project is: claude/chapters/05-claude-cowork-as-file-and-workflow-agent.md
