...
# Ship It: Export, Name, Submit + the Jargon Test

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 7 — SHIP THE PITCH (E7/7)

This is Humanitarians.

The current plan contains **9 beats**. Its runtime is derived from 9 beats. The source recorded by the project is: INFO 7375 Assignment 7 brief — Video Pitch to Investors: pre-submit checklist, export, naming, Canvas submit
