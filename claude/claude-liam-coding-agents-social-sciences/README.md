...
# Claude, Peer-Reviewed.

## What this video is about

**Topic:** CODING AGENTS IN THE SOCIAL SCIENCES

This is Kore for Humanitarians AI.

The current plan contains **12 beats**. Its runtime is derived from 12 beats. The source recorded by the project is: Anthropic, 'Coding agents in the social sciences' (May 27, 2026). Lyttelton, Massenkoff, Wilmers. Survey of 1,260 quantitative social scientists, Feb–Mar 2026.
