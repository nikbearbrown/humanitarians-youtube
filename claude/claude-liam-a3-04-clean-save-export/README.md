...
# Build the Pipeline, Part 2: Clean, Save, Export

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 3 — CLEAN SAVE EXPORT (E4/7)

This is Liam for Humanitarians AI.

The current plan contains **9 beats**. Its runtime is derived from 9 beats. The source recorded by the project is: INFO 7375 Assignment 3 brief — Shop for Ingredients: Collect Your Madison Data
