...
This is Humanitarians AI. This is Liam, in for Bear. An agent with 200 features to implement. It completes 50 in session one and the context window fills. Session two starts blank. How does it know to begin at feature 51 — without replaying the first 50?

The current plan contains **9 beats**. Its runtime is 136.42. The source recorded by the project is: autonomous-coding/autonomous_agent_demo.py
