...
## Build facts
- Runtime: 190.4s | Beats: 11/11 VIDEO | Audio: Kokoro af_kore (free)
- Streams: video + audio confirmed (compile.py)

## Frame verification
| Timestamp | Beat | Pattern | Result |
|---|---|---|---|
| 1s | B00 | ClaudeComposerAsk | PASS — "DANCE-VIDEO · SKILL TEARDOWN", "Kore, in for Humanitarians AI.", "Talofa, Kore", 4 output lines |
...
| 188s | BOUT | ClaudeTitleOutro | PASS — "Claude, Dancing." / @HumanitariansAI / "Kore, in for Humanitarians AI." |

## 9-point rubric
1. IN-FOR-BEAR: "Kore, in for Humanitarians AI." visible at 1s — PASS
2. HELLO: "Talofa, Kore" (Samoan) in B00 — PASS
