...
# Assemble a Research Packet with Source Traceability
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: claude-cowork/chapters/09-research-packets-and-meeting-notes.md
