...
# Build a 3-Pass Prompt Refinement Demo with Claude
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: claude-prompt-engineering/chapters/06-iteration-and-revision-loops.md
