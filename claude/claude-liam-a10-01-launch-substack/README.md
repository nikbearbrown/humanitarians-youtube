...
# Own Your Home: Launch a Brand-Aligned Substack

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 10 — LAUNCH SUBSTACK (E1/5)

This is Humanitarians.

The current plan contains **8 beats**. Its runtime is derived from 8 beats. The source recorded by the project is: INFO 7375 Assignment 10 brief — Self-Promotion Through Thought Leadership
