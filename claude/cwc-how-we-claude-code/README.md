...
The current plan contains **9 beats**. Its runtime is derived from 9 beats. The source recorded by the project is: CWC Workshop — How We Claude Code (Anthropic internal workflow)
