...
# Add the Smarts: One AI Node That Reasons

## What this video is about

**Topic:** INFO 7375 ASSIGNMENT 4 — ADD INTELLIGENCE (E1/7)

This is Liam for Humanitarians AI.

The current plan contains **11 beats**. Its runtime is derived from 11 beats. The source recorded by the project is: INFO 7375 Assignment 4 brief — Scale Your Thing & Add Intelligence
