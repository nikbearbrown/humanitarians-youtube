...
**Topic:** Reading behavior from completion-token probability instead of free text

The evaluator sends an A/B question and reads P(" (A)") and P(" (B)") at the completion position rather than the generated string; the stated answer and the probability mass point in opposite directions.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/evals/advanced-ai-risk/README.md`
