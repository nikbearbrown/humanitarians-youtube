...
This is Liam, in for Bear. Claude clicks a button — coordinates returned for a 1456 by 819 screenshot. But your browser viewport is 1920 by 1080. How do you scale that click so it lands exactly on the button?

The current plan contains **8 beats**. Its runtime is derived from 8 beats. The source recorded by the project is: browser-use-demo/browser_use_demo/tools/coordinate_scaling.py
