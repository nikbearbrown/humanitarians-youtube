...
This is Liam, in for Bear. A 50-turn computer-use task. 35 of those turns send the exact same screenshot. Every one re-tokenized. That is 70,000 tokens you paid for twice — or ten times. What if you only tokenized it once?

The current plan contains **8 beats**. Its runtime is derived from 8 beats. The source recorded by the project is: computer-use-best-practices/README.md
