...
This is Kore, in for Humanitarians AI. A 50-turn computer-use task. 35 of those turns send the exact same screenshot. Every one re-tokenized. That is 70,000 tokens you paid for twice — or ten times. What if you only tokenized it once?
