...
**Topic:** Input structure as a retrieval constraint

`Product Name: LeapFrog... Letters and words woven...` vs. the same inside `<search_result><title>LeapFrog</title><content>...</content></search_result>` produces noticeably different synthesis.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/anthropic-retrieval-demo/README.md`
