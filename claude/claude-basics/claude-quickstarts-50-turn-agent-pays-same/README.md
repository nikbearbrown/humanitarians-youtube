...
**Topic:** Prompt caching for unchanged screens

A 50-turn form-filling task revisits only 5 unique desktop states. Naive: 50 × 2,000 = 100,000 image tokens. With ephemeral cache_control on first sight of each state: 5 × 2,000 = 10,000 tokens; the other 45 turns are cache hits.
