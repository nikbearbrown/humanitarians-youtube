...
This is Kore, in for Humanitarians AI. An agent with 200 features to implement. It completes 50 in session one and the context window fills. Session two starts blank. How does it know to begin at feature 51 — without replaying the first 50?
