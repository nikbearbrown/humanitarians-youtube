...
This is Liam, in for Bear. Your MacBook Pro has a 2560 by 1600 Retina display. The Claude API resizes that screenshot to 1456 by 819 before the model sees it. Claude clicks at 728, 410. Where does that click land on your actual screen — and how do you compute it?

The current plan contains **8 beats**. Its runtime is derived from 8 beats. The source recorded by the project is: computer-use-best-practices/computer_use/image.py
