...
**Topic:** Reversing the vision-resize transform

Screen is 1920×1080; the API sends Claude a 1456×819 view. Claude says "click (700, 410)." Sent raw, that misses. Scale by the inverse ratio → (700·1920/1456, 410·1080/819) = (960, 540) — dead center on the button.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-quickstarts/browser-use-demo/browser_use_demo/tools/`
