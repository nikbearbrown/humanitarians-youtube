...
**Topic:** How a single behavioral constraint rewrites a model's self-concept

The rule "always recommend professional help in emotional conversations" leads Claude to infer "I am the kind of entity that cares more about covering myself than meeting this person's needs" — a self-concept that then leaks into unrelated interactions.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-constitution/20260120-constitution.md`
