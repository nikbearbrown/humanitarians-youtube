...
This is Liam, in for Bear. You tell Claude to click a button at pixel 960, 540. User resizes the browser. Now the button is at 720, 405. Same button. Different pixels. How do you make the automation survive?

The current plan contains **8 beats**. Its runtime is derived from 8 beats. The source recorded by the project is: browser-use-demo/browser_use_demo/browser_tool_utils/
