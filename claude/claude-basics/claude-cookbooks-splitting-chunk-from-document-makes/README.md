...
**Topic:** Context restored before embedding

A medical paper split into 20 chunks. Chunk 7: "This treatment reduced mortality by 12%" — no disease named. BM25 hands it to a "diabetes mortality" query on the word match. Prepend "Context: hypertension study in elderly patients" before embedding and it stops matching diabetes queries.

The current plan contains **6 beats**. Its runtime is derived from 6 beats. The source recorded by the project is: `anthropics/claude-cookbooks/capabilities/contextual-embeddings/README.md`
