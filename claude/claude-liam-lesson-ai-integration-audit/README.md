...
# Build a Lesson AI-Integration Audit with Claude
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: claude-for-education-a-practitioners-guide/chapters/01-what-claude-can-and-cannot-do-in-education.md
