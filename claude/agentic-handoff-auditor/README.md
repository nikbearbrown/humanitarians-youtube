...
# Build an Agentic Prompt Handoff Auditor with Claude
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: claude-prompt-engineering/chapters/11-prompts-as-handoffs-to-claude-code-and-cowork.md
