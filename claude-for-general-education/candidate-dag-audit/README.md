...
# Build a Candidate DAG and Audit It with Claude
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: causal-reasoning/chapters/03-the-map-before-the-territory.md
