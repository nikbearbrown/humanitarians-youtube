...
# Agent Self-Verification Failure: When LLMs Confirm Wrong Answers

## What this video is about

**Topic:** COMPUTATIONAL SKEPTICISM — SELF-VERIFICATION FAILURE

This is Liam for Humanitarians AI.

The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: See the local source and fact-check files.
