...
# Adapt It + Justify It in Botspeak

## What this video is about

**Topic:** INFO 7375 BOTSPEAK PROMPT ADAPTATION — E3/5 — DOMAIN ADAPTATION (21 pts) + JUSTIFICATION (11 pts)

This is Humanitarians.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 (Computational Skepticism for AI) — Botspeak Prompt Adaptation (100 pts)
