...
# Spec Before You Build: The Five Components

## What this video is about

**Topic:** INFO 7375 BOTSPEAK PROMPT ADAPTATION — E2/5 — SPECIFICATION RIGOR (16 pts)

This is Liam for Humanitarians AI.

The current plan contains **11 beats**. Its runtime is derived from 11 beats. The source recorded by the project is: INFO 7375 (Computational Skepticism for AI) — Botspeak Prompt Adaptation (100 pts)
