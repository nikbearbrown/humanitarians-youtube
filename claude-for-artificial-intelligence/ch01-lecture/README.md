...
# What AI+1 Is and Why It Works

## What this video is about

**Topic:** Claude For Artificial Intelligence

This video explains what ai+1 is and why it works through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/01-what-ai-plus-one-is.md
