...
**Topic:** INFO 7375 WEEK 1 — BUILD THE SDD (E2/4)

Ciao — this is Liam. Episode 2 of 4. Run the sequence and let Gru push. The Software Design Document — the SDD — is only worth grading if it shows the pushback you resolved. Don't clean it up. The flags Gru raises are the evidence of your thinking. A polished SDD with no flags is a document that was easy to write. That's not what this assignment is measuring.

The current plan contains **8 beats**. Its runtime is derived from 8 beats. The source recorded by the project is: INFO 7375 (Computational Skepticism for AI) — Week 1: The Boondoggle Report (25 pts)
