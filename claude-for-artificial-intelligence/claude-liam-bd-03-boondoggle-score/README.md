...
# Generate & Read the Boondoggle Score

## What this video is about

**Topic:** INFO 7375 WEEK 1 — THE BOONDOGGLE SCORE (E3/4)

This is Humanitarians.

The current plan contains **9 beats**. Its runtime is derived from 9 beats. The source recorded by the project is: INFO 7375 (Computational Skepticism for AI) — Week 1: The Boondoggle Report (25 pts)
