...
# Medhavy: the AI-Tutor Layer via LTI

## What this video is about

**Topic:** Claude For Artificial Intelligence

This video explains medhavy: the ai-tutor layer via lti through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/19-medhavy-lti.md
