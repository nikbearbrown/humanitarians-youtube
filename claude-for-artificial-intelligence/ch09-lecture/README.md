...
# Finishing Pass and Figures

## What this video is about

**Topic:** Claude For Artificial Intelligence

This video explains finishing pass and figures through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/09-finishing-pass-and-figures.md
