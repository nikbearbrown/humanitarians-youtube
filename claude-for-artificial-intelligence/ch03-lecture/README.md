...
# Domain Research: The Chapter Before the Chapter

## What this video is about

**Topic:** Claude For Artificial Intelligence

This video explains domain research: the chapter before the chapter through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/03-domain-research.md
