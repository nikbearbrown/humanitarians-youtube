...
# What Tic TOC Does and Why You Spend Two Hours Here First

## What this video is about

**Topic:** Claude For Artificial Intelligence

This video explains what tic toc does and why you spend two hours here first through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/02-what-tic-toc-does.md
