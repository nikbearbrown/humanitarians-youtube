...
# Diagnose a Model's Causal Claims with Claude
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: causal-reasoning/chapters/01-the-decision-that-looked-right.md
