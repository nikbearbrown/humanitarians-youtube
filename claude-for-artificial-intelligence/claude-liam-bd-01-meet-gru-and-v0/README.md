...
**Topic:** INFO 7375 WEEK 1 — MEET GRU & SCOPE YOUR APP (E1/4)

Ciao — this is Liam. Episode 1 of 4. Before you can evaluate an AI system, you have to specify one precisely. Gru is the fastest way to build that muscle — and its first gate will stop a vague idea cold. Good. This week runs in four episodes: scope your app in Gru, build the full SDD, generate and read the Boondoggle Score, then write the reflection and ship. Every episode has a concrete deliverable. This one has on…

The current plan contains **7 beats**. Its runtime is derived from 7 beats. The source recorded by the project is: INFO 7375 (Computational Skepticism for AI) — Week 1: The Boondoggle Report (25 pts)
