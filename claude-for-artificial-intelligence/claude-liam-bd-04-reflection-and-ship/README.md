...
# Read the Answer: The Reflection + Ship

## What this video is about

**Topic:** INFO 7375 WEEK 1 — REFLECTION & SHIP (E4/4)

This is Humanitarians.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: INFO 7375 (Computational Skepticism for AI) — Week 1: The Boondoggle Report (25 pts)
