...
# Final Check and Build: EPUB + PDF

## What this video is about

**Topic:** Claude For Artificial Intelligence

This video explains final check and build: epub + pdf through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: chapters/12-final-check-and-build.md
