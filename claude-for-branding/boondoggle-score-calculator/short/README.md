...
# Build a Boondoggle Score Calculator with Claude

## What this video is about

**Topic:** BRANDING AND AI · AI SEAM

This is Humanitarians AI. Bula — this is Liam, in for Bear. For Nina Harris' course, Branding and AI, here is the question we are running today: point at any task on your plate and this tool tells you whether you have split it right — AI on the pattern-work, you on the judgment — or handed the machine the part it was never good at. Most AI failures are seam failures. We are building the score that makes the seam exp…

The current plan contains **8 beats**. Its runtime is 160.03. The source recorded by the project is: See the local source and fact-check files.
