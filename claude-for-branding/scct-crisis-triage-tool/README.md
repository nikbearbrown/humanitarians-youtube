...
# Build an SCCT Crisis Triage Tool with Claude

## What this video is about

**Topic:** CLAUDE CODE · REPUTATION MANAGEMENT

This is Humanitarians.

The current plan contains **12 beats**. Its runtime is 122. The source recorded by the project is: See the local source and fact-check files.
