...
# Build a Self-as-Project Brand Runner with Claude

## What this video is about

**Topic:** BRANDING AND AI · SELF AS PROJECT

This is Humanitarians AI. Talofa — this is Liam, in for Bear. For Nina Harris' course, Branding and AI, here is the question we are running today: run your own career through the same pipeline the book runs a brand through — archetype, position, voice, portfolio thesis — with Claude drafting each stage and you signing it off. The accountability log records which drafts you approved, edited, or rejected. The log prov…

The current plan contains **8 beats**. Its runtime is 164.94. The source recorded by the project is: See the local source and fact-check files.
