...
This is Humanitarians AI. Hej — this is Kore, in for Humanitarians AI. For Nina Harris' course, Branding and AI, here is the question we are running today: without a committed archetype, every brand decision is an open debate. With one, every decision is a filter. We are building the classifier that makes the archetype chooseable in five inputs.
