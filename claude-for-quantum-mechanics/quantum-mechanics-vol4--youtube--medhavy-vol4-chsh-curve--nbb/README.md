...
# Build a CHSH Correlation Curve with Claude Code
...
The current plan contains **8 beats**. Its runtime is 167.26. The source recorded by the project is: See the local source and fact-check files.
