...
# Build Fermi's Golden Rule with Claude Code
...
The current plan contains **8 beats**. Its runtime is 140.75. The source recorded by the project is: See the local source and fact-check files.
