...
# Why the Born Rule Is Like Measuring a Shadow
...
The current plan contains **15 beats**. Its runtime is derived from 15 beats. The source recorded by the project is: quantum-mechanics-vol2/chapters/02-observables-and-the-spectral-theorem.md
