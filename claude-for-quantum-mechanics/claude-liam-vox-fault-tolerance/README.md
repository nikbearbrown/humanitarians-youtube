...
# When Fixing One Qubit Breaks Two
...
The current plan contains **18 beats**. Its runtime is 159.22. The source recorded by the project is: quantum-mechanics-vol4/chapters/09-error-and-the-threshold-theorem.md
