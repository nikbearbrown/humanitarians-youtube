...
# Build a Decoherence T2 Decay Curve with Claude Code + Manim
...
The current plan contains **8 beats**. Its runtime is 106.24. The source recorded by the project is: See the local source and fact-check files.
