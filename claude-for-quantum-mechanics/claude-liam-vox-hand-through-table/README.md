...
The current plan contains **15 beats**. Its runtime is derived from 15 beats. The source recorded by the project is: quantum-mechanics-a-companion-guide/chapters/08-identical-particles.md
