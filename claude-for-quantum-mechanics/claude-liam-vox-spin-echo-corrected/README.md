...
The current plan contains **16 beats**. Its runtime is derived from 16 beats. The source recorded by the project is: quantum-mechanics-vol3/chapters/09-atoms-in-fields.md
