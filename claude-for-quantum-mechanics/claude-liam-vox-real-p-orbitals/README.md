...
# Why Chemistry's Orbitals Aren't the Physicist's

## What this video is about

**Topic:** QUANTUM MECHANICS — ORBITAL BASES

This is Humanitarians.

The current plan contains **17 beats**. Its runtime is derived from 17 beats. The source recorded by the project is: quantum-mechanics-vol2/chapters/05-quantum-mechanics-in-three-dimensions.md
