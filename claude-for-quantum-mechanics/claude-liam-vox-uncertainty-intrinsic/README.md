...
# Why Uncertainty Isn't About Bumping the Particle

## What this video is about

**Topic:** QUANTUM MECHANICS · THE INTRINSIC LIMIT

This is Liam for Humanitarians AI.

The current plan contains **22 beats**. Its runtime is 243. The source recorded by the project is: quantum-mechanics-vol1/chapters/09-operators-and-uncertainty.md
