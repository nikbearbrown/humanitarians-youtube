# QC Report — Why Uncertainty Isn't About Bumping the Particle

- Verdict: PASS (verified reuse)
- Output: `vox-uncertainty-intrinsic.mp4`
...
Source: `quantum-mechanics-a-companion-guide/youtube/claude-liam-vox-uncertainty-state/vox-uncertainty-state.mp4`.
