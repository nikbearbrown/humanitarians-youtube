...
# The Free Particle: Why a Plane Wave Fails and How a Wave Packet Saves It

## What this video is about

**Topic:** The Free Particle and Wave Packets

This is Kore for Humanitarians AI.

The current plan contains **5 beats**. Its runtime is 20.12. The source recorded by the project is: See the local source and fact-check files.
