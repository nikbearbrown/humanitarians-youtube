...
The current plan contains **18 beats**. Its runtime is 163.2. The source recorded by the project is: quantum-mechanics-vol3/chapters/01-time-independent-perturbation-theory.md
