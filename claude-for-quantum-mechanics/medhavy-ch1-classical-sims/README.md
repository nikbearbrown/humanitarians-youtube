...
# Build Physics Sims with Claude Code + Manim

## What this video is about

**Topic:** QUANTUM MECHANICS · BUILD PHYSICS SIMS

This is Humanitarians.

The current plan contains **18 beats**. Its runtime is derived from 18 beats. The source recorded by the project is: See the local source and fact-check files.
