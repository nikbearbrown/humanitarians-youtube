...
# Why a Particle Bounces Off a Cliff It Could Easily Clear

## What this video is about

**Topic:** QUANTUM MECHANICS — STEP REFLECTION

This is Liam for Humanitarians AI.

The current plan contains **16 beats**. Its runtime is derived from 16 beats. The source recorded by the project is: quantum-mechanics-vol1/chapters/06-finite-wells-steps-and-barriers.md
