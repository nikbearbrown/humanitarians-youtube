...
# Why the Wave Crests Move Twice as Fast as the Packet

## What this video is about

**Topic:** QUANTUM MECHANICS · PHASE VS GROUP

This is Humanitarians.

The current plan contains **29 beats**. Its runtime is derived from 29 beats. The source recorded by the project is: See the local source and fact-check files.
