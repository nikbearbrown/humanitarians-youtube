...
# Why You Don't Diffract Walking Through a Doorway

## What this video is about

**Topic:** QUANTUM MECHANICS — HUMAN DE BROGLIE WAVELENGTH

This is Liam for Humanitarians AI.

The current plan contains **16 beats**. Its runtime is derived from 16 beats. The source recorded by the project is: quantum-mechanics-vol1/chapters/02-matter-waves.md
