...
# Build a Fourier Bandwidth-Duration Uncertainty Demo with Claude Code + Manim
...
The current plan contains **8 beats**. Its runtime is 105.27. The source recorded by the project is: See the local source and fact-check files.
