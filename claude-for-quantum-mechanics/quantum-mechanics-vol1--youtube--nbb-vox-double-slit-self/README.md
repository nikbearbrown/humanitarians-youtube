...
# Why One Electron Builds an Interference Pattern by Itself

## What this video is about

**Topic:** QUANTUM MECHANICS · ONE ELECTRON

This is Liam for Humanitarians AI.

The current plan contains **24 beats**. Its runtime is derived from 24 beats. The source recorded by the project is: See the local source and fact-check files.
