...
# How Unitarity Leads to the Schrödinger Form
...
The current plan contains **15 beats**. Its runtime is derived from 15 beats. The source recorded by the project is: quantum-mechanics-vol2/chapters/04-quantum-dynamics-and-the-pictures.md
