...
The current plan contains **18 beats**. Its runtime is 203.6. The source recorded by the project is: quantum-mechanics-vol3/chapters/03-the-variational-principle.md
