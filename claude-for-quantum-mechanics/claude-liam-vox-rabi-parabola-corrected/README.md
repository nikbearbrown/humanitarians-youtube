...
The current plan contains **15 beats**. Its runtime is derived from 15 beats. The source recorded by the project is: quantum-mechanics-vol3/chapters/05-time-dependent-perturbation-theory-and-transitions.md
