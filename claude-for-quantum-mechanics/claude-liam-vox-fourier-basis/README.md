...
# Why the Fourier Transform Is Just Turning Your Head

## What this video is about

**Topic:** QUANTUM MECHANICS — REPRESENTATIONS

This is Humanitarians.

The current plan contains **17 beats**. Its runtime is derived from 17 beats. The source recorded by the project is: quantum-mechanics-vol2/chapters/01-the-formalism.md
