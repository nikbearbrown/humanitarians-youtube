...
# Why a Particle Can Walk Through a Wall

## What this video is about

**Topic:** QUANTUM MECHANICS · THROUGH THE WALL

This is Kore for Humanitarians AI.

The current plan contains **22 beats**. Its runtime is 214. The source recorded by the project is: quantum-mechanics-vol1/chapters/06-finite-wells-steps-and-barriers.md
