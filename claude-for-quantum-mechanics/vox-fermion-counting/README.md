...
# Why three particles in two states give only one arrangement
...
The current plan contains **14 beats**. Its runtime is 182.26. The source recorded by the project is: quantum-mechanics-vol5/chapters/14-combinatorics-and-multiplicity.md
