...
# Why Matter Has Structure: Pauli as a Fact About Determinants
...
The current plan contains **14 beats**. Its runtime is 5.7. The source recorded by the project is: quantum-mechanics-vol2/chapters/10-identical-particles.md
