...
# Why the Electron Can't Be a Tiny Spinning Ball
...
The current plan contains **14 beats**. Its runtime is 170.85. The source recorded by the project is: quantum-mechanics-vol2/chapters/07-spin-and-the-bloch-sphere.md
