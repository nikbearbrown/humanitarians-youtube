...
# Build a Fourier Square Wave with Claude Code + Manim
...
The current plan contains **8 beats**. Its runtime is 108.66. The source recorded by the project is: See the local source and fact-check files.
