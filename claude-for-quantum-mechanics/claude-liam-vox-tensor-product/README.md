...
# Why Two Qubits Live in a Space That Multiplies, Not Adds
...
The current plan contains **16 beats**. Its runtime is 157.32. The source recorded by the project is: quantum-mechanics-vol4/chapters/02-composite-systems-and-entanglement.md
