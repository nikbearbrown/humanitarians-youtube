...
# Build Group vs Phase Velocity with Claude Code + Manim
...
The current plan contains **8 beats**. Its runtime is 107.82. The source recorded by the project is: See the local source and fact-check files.
