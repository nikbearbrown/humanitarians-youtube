...
# Why the Born Rule Is Just Measuring the Length of a Shadow
...
The current plan contains **15 beats**. Its runtime is 179.87. The source recorded by the project is: quantum-mechanics-vol2/chapters/02-observables-and-the-spectral-theorem.md
