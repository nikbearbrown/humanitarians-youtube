...
# Why a Quantum Packet Becomes Chirped as It Spreads

## What this video is about

**Topic:** QUANTUM MECHANICS — FREE-PACKET CHIRP

This is Humanitarians.

The current plan contains **16 beats**. Its runtime is derived from 16 beats. The source recorded by the project is: quantum-mechanics-vol1/chapters/08-the-free-particle-and-wave-packets.md
