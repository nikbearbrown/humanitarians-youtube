...
# Quantum revival: the shape that falls apart and reassembles
...
The current plan contains **14 beats**. Its runtime is 112.94. The source recorded by the project is: Vol. 5, M-05 (Fourier Series and the Wave Equation), parabolic state in the square well
