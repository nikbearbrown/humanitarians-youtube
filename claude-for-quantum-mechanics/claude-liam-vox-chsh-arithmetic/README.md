...
# The Hidden Rule Behind the Classical Limit of 2
...
The current plan contains **19 beats**. Its runtime is 198.79. The source recorded by the project is: quantum-mechanics-vol4/chapters/03-bells-theorem-and-chsh.md
