...
**Topic:** QUANTUM MECHANICS — INCOMPATIBLE MEASUREMENTS

This is Humanitarians.

The current plan contains **16 beats**. Its runtime is derived from 16 beats. The source recorded by the project is: quantum-mechanics-vol1/chapters/10-measurement-and-the-qubit.md
