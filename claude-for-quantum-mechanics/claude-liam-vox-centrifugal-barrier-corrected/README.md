...
# Why the Centrifugal Barrier Is Angular Kinetic Energy
...
The current plan contains **15 beats**. Its runtime is derived from 15 beats. The source recorded by the project is: quantum-mechanics-vol2/chapters/05-quantum-mechanics-in-three-dimensions.md
