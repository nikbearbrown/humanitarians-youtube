...
# The band gap width is just one Fourier coefficient
...
The current plan contains **14 beats**. Its runtime is 184.58. The source recorded by the project is: quantum-mechanics-vol5/chapters/05-fourier-series-and-the-wave-equation.md
