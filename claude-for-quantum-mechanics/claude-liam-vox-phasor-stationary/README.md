...
# The phasor that spins but never changes anything
...
The current plan contains **14 beats**. Its runtime is 101.64. The source recorded by the project is: Vol. 5, M-01 (Complex Numbers and the Complex Exponential), In the Quantum Series — stationary-state phasor
