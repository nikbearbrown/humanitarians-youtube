...
# Eigenvectors: the directions a matrix can't turn
...
The current plan contains **14 beats**. Its runtime is 110.31. The source recorded by the project is: Vol. 5, M-08 (Eigenvalues and Diagonalization), The Eigenvalue Problem: Invariant Directions
