...
# Why the Electron Has No Orbit, Only a Cloud
...
The current plan contains **15 beats**. Its runtime is 132.09. The source recorded by the project is: quantum-mechanics-vol2/chapters/09-the-hydrogen-atom.md
