...
# Build a Quantum Tunneling Simulator with Claude Code + Manim
...
The current plan contains **8 beats**. Its runtime is 112.34. The source recorded by the project is: See the local source and fact-check files.
