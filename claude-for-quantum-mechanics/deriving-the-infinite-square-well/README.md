...
# Deriving the Infinite Square Well: Where Energy Quantization Comes From

## What this video is about

**Topic:** The Infinite Square Well

This is Humanitarians.

The current plan contains **5 beats**. Its runtime is 19.59. The source recorded by the project is: See the local source and fact-check files.
