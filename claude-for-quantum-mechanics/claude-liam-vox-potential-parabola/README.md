...
# Every valley is a parabola if you lean in close enough
...
The current plan contains **14 beats**. Its runtime is 111.81. The source recorded by the project is: Vol. 5, M-04 (Series Expansions and Approximation), Every Smooth Potential Near a Minimum Is a Harmonic Oscillator
