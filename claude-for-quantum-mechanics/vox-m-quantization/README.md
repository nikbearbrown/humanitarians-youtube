...
# Why m has to be a whole number
...
The current plan contains **15 beats**. Its runtime is 154.52. The source recorded by the project is: quantum-mechanics-vol5/chapters/10-multivariable-calculus-and-separation-of-variables.md
