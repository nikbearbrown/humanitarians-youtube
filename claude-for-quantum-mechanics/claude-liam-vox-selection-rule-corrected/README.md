...
# Why Some Light an Atom Should Emit Is Forbidden
...
The current plan contains **15 beats**. Its runtime is derived from 15 beats. The source recorded by the project is: quantum-mechanics-vol3/chapters/06-radiation-and-fermis-golden-rule.md
