...
# Build a Particle-in-a-Box Energy Ladder with Claude Code + Manim

## What this video is about

**Topic:** CLAUDE CODE · MANIM

This is Humanitarians AI. Medhavy A-I. From Sanskrit — meaning intelligent, or intellectually brilliant. The perfect name for our A-I-powered intelligent learning systems.

The current plan contains **3 beats**. Its runtime is 39.68. The source recorded by the project is: See the local source and fact-check files.
...
5. **Generate local audio:** use Kokoro voice `am_onyx` in the Wonder register. Measured audio durations become the master clock; never repair timing by hand.
