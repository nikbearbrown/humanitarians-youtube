...
# A quantum matter wave has two speeds — and the one you can see is the wrong one
...
The current plan contains **14 beats**. Its runtime is 170.26. The source recorded by the project is: quantum-mechanics-vol5/chapters/18-trigonometry-waves-and-the-harmonic-model.md
