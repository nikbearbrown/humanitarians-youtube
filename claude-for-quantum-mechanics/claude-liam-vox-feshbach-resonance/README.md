...
The current plan contains **18 beats**. Its runtime is 174.87. The source recorded by the project is: quantum-mechanics-vol3/chapters/07-scattering-i-partial-waves.md
