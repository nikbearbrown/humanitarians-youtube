...
# Why Angular Momentum Comes in a Ladder
...
The current plan contains **17 beats**. Its runtime is derived from 17 beats. The source recorded by the project is: quantum-mechanics-vol2/chapters/06-angular-momentum.md
