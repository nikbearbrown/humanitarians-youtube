...
# Why a Probability Density Can Be Greater Than One

## What this video is about

**Topic:** QUANTUM MECHANICS — PROBABILITY DENSITY

This is Liam for Humanitarians AI.

The current plan contains **16 beats**. Its runtime is derived from 16 beats. The source recorded by the project is: quantum-mechanics-vol1/chapters/03-the-wave-function.md
