...
The current plan contains **16 beats**. Its runtime is 119.1. The source recorded by the project is: quantum-mechanics-vol3/chapters/03-the-variational-principle.md
