...
# Why the Nondegenerate Ground State's Second-Order Shift Is Never Positive
...
The current plan contains **17 beats**. Its runtime is 188. The source recorded by the project is: quantum-mechanics-vol3/chapters/01-time-independent-perturbation-theory.md
