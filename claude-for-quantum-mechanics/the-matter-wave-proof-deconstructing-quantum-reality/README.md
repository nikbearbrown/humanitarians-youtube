...
# The Matter Wave Proof: De Broglie, Davisson–Germer, and Wave–Particle Duality

## What this video is about

**Topic:** Matter Waves: de Broglie, Davisson–Germer, and the Double Slit

This is Humanitarians.

The current plan contains **5 beats**. Its runtime is 21.29. The source recorded by the project is: See the local source and fact-check files.
