...
The current plan contains **17 beats**. Its runtime is derived from 17 beats. The source recorded by the project is: quantum-mechanics-vol3/chapters/11-capstone-modeling-a-real-quantum-system.md
