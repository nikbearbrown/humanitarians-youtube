...
# Why 4s Fills Before 3d but Leaves First
...
The current plan contains **15 beats**. Its runtime is derived from 15 beats. The source recorded by the project is: quantum-mechanics-vol2/chapters/11-capstone-the-atom.md
