...
# Why the Centrifugal Barrier Is Kinetic Energy Pretending to Be a Force
...
The current plan contains **15 beats**. Its runtime is 192.71. The source recorded by the project is: quantum-mechanics-vol2/chapters/05-quantum-mechanics-in-three-dimensions.md
