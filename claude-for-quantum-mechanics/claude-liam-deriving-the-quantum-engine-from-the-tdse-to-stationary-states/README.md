...
# The Quantum Engine: Deriving Stationary States from the Schrödinger Equation

## What this video is about

**Topic:** The Schrödinger Equation and Stationary States

This is Humanitarians.

The current plan contains **5 beats**. Its runtime is 20.66. The source recorded by the project is: See the local source and fact-check files.
