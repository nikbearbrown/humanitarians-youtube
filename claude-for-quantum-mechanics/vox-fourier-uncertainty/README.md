...
# Squeeze the position, the momentum spreads (uncertainty is just Fourier)
...
The current plan contains **14 beats**. Its runtime is 108.35. The source recorded by the project is: Vol. 5, M-06 (The Fourier Transform), Bandwidth Relation and the Uncertainty Principle + Gaussian minimum-uncertainty
