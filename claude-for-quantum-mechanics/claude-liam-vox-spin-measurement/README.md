...
# Measuring spin in one direction destroys what you knew about another
...
The current plan contains **14 beats**. Its runtime is 184.86. The source recorded by the project is: quantum-mechanics-vol5/chapters/12-matrices-determinants-and-linear-systems.md
