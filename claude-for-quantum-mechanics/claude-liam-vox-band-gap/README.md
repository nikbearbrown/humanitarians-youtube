...
The current plan contains **15 beats**. Its runtime is 134.2. The source recorded by the project is: quantum-mechanics-vol3/chapters/10-periodic-potentials-and-band-structure.md
