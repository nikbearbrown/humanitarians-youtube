...
# Rotate an electron all the way around and it comes back wrong
...
The current plan contains **14 beats**. Its runtime is 174.5. The source recorded by the project is: quantum-mechanics-vol5/chapters/01-complex-numbers-and-the-complex-exponential.md
