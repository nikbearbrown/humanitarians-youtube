...
# Two Different Labs, the Same Quantum State
...
The current plan contains **18 beats**. Its runtime is 147.35. The source recorded by the project is: quantum-mechanics-vol4/chapters/01-mixed-states-and-the-density-matrix.md
