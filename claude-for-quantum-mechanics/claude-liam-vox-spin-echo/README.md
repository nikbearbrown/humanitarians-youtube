...
The current plan contains **15 beats**. Its runtime is 129.6. The source recorded by the project is: quantum-mechanics-vol3/chapters/09-atoms-in-fields.md
