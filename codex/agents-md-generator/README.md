...
# Build an AGENTS.md Generator for Any Coding Project with Codex
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: codex-for-students/chapters/07-agents-md.md
