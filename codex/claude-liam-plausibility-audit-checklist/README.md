...
# Build a Plausibility Audit Checklist with Claude: Name the Five Capacities

## What this video is about

**Topic:** CODEX FOR TEACHERS

This is Liam for Humanitarians AI.

The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: codex-for-teachers/chapters/06-five-supervisory-capacities.md
