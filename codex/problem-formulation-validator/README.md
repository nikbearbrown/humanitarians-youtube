...
# Validate Your Build Problem Formulation Before Running Codex
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: codex-for-students/chapters/08-problem-formulation.md
