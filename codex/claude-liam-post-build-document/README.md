...
# Write the Post-Build Document with Claude: Account for Every Decision
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: codex-for-teachers/chapters/16-post-build-document.md
