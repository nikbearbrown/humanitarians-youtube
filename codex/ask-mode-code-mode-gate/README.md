...
# Measure the Ask Mode/Code Mode Gate: With vs. Without
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: codex-for-students/chapters/05-conducting-not-prompting.md
