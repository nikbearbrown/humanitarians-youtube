...
# Build a Five-Element Specification Generator for Codex Prompts

## What this video is about

**Topic:** CODEX FOR STUDENTS

This is Humanitarians.

The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: codex-for-students/chapters/09-prompts-as-specifications.md
