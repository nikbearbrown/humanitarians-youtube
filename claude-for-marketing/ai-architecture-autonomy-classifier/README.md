...
# Build an AI Architecture Autonomy Classifier with Claude

## What this video is about

**Topic:** CLAUDE CODE · AI SYSTEMS

This is Humanitarians.

The current plan contains **12 beats**. Its runtime is 120. The source recorded by the project is: See the local source and fact-check files.
