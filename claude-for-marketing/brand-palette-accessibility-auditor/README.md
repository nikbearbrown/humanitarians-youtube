...
# Build a Brand Palette Accessibility Auditor with Claude

## What this video is about

**Topic:** CLAUDE CODE · VISUAL IDENTITY

This is Humanitarians.

The current plan contains **12 beats**. Its runtime is 114. The source recorded by the project is: See the local source and fact-check files.
