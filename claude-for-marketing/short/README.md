...
This is Humanitarians AI. Aloha — this is Kore, in for Humanitarians AI. For Nina Harris' course, Branding and AI, here is the question we are running today: Tropicana did not lose its recipe. Gap did not close its stores. New Coke was not bad product. They lost their recognition asset — and that asset is invisible until it is destroyed. We are using Claude to synthesize the three canonical cases and extract the fou…
