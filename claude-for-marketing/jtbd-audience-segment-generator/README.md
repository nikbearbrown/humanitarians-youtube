...
# Build a JTBD Audience Segment Generator with Claude

## What this video is about

**Topic:** CLAUDE CODE · BRAND AUDIENCE

This is Liam for Humanitarians AI.

The current plan contains **12 beats**. Its runtime is 116. The source recorded by the project is: See the local source and fact-check files.
