...
# Recency Beats Size: Why the Seed-Round Lab Outranks the $220M Incumbent
...
The current plan contains **14 beats**. Its runtime is 145.09. The source recorded by the project is: the-reallocation-engine/chapters/06-where-the-money-went-sec-form-d.md
