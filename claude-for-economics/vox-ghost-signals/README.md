...
# The Ghost Job You Can't See: Five Signals That Read the Posting, Not the Prose
...
The current plan contains **16 beats**. Its runtime is 131.58. The source recorded by the project is: the-reallocation-engine/chapters/08-is-the-job-real-ats-detection-and-liveness.md
