...
# The Wrong Job: Why the Silent SOC Mismatch Is the Costliest Error
...
The current plan contains **15 beats**. Its runtime is 144.23. The source recorded by the project is: the-reallocation-engine/chapters/09-is-the-role-any-good-bls-onet-role-quality.md
