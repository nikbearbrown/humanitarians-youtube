...
# Why the 90-Day Clock Is a Gate, Not a Tiebreaker
...
The current plan contains **16 beats**. Its runtime is 121.19. The source recorded by the project is: the-reallocation-engine/chapters/10-the-visa-timeline-manager.md
