...
# Effort Optimization Gone Wrong: Why the Disciplined Job Seeker Is Usually Misallocated
...
The current plan contains **14 beats**. Its runtime is 127.91. The source recorded by the project is: the-reallocation-engine/chapters/02-the-reallocation-principle.md
