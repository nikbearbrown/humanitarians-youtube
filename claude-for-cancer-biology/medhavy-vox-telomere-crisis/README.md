...
# Why Telomere Shortening Is Both a Cancer Brake and a Cancer Accelerator
...
The current plan contains **17 beats**. Its runtime is 156.64. The source recorded by the project is: cancer-biology/chapters/04-genetics-and-genomic-instability-in-cancer.md
