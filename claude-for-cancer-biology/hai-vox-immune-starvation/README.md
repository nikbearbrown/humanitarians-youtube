...
# Why Tumors Make the Immune Cells That Could Kill Them Run Out of Fuel
...
The current plan contains **18 beats**. Its runtime is 299.99. The source recorded by the project is: cancer-biology/chapters/16-cancer-metabolism-lipids-amino-acids-and-the-tumor-microenvironment.md
