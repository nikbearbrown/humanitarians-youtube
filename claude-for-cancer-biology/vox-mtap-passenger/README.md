...
# Why a Deleted Passenger Gene Creates a Target the Driver Gene Never Could
...
The current plan contains **18 beats**. Its runtime is 155.75. The source recorded by the project is: cancer-biology/chapters/16-cancer-metabolism-lipids-amino-acids-and-the-tumor-microenvironment.md
