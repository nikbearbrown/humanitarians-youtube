...
# Why Cancer Is Evolution Running Inside the Body
...
The current plan contains **18 beats**. Its runtime is 219.81. The source recorded by the project is: cancer-biology/chapters/04-genetics-and-genomic-instability-in-cancer.md
