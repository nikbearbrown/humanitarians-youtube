...
The current plan contains **19 beats**. Its runtime is derived from 19 beats. The source recorded by the project is: See the local source and fact-check files.
