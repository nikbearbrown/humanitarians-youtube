...
also wires the derived folder together with symlinks. Neither fits here:
  ...
  1. The ask was for the SAME video in both aspect ratios, not a trimmed
     teaser. This reel measures 3:07 — `shorts.py` would silently drop a body
...
def main() -> int:
    ...
    meta["derived_from"] = "ai-data-quality"
    meta["kind"] = "vertical-full"
    meta["note"] = (
        "FULL-LENGTH 9:16 derivative of ai-data-quality — every beat kept, no "
