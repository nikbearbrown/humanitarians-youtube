...
**Fellow:** Charitha Sree Veluru · **Date:** August 31, 2026 · **Folder:** `2026-08-31-why-putting-the-simulation-at-the-bottom-breaks-the-lesson`  
**Series:** Humanitarians AI Fellows — Physics Vol. 1 · **Voice:** Kokoro `af_bella` (pending approval)

> FigureWithSim keeps citation and tool in one viewport — bottom galleries break the lesson pointer.

## Masters (Drive — not in git)

| File | Aspect |
|------|--------|
| `physics_vol_1_ch4_Charitha_Sree_Veluru_video2_16x9.mp4` | 16:9 · 4K |
| `physics_vol_1_ch4_Charitha_Sree_Veluru_video2_9x16.mp4` | 9:16 · 4K |
...
| B01 | HOOK | VOX | 18s |
| B02 | CONTRAST | VOX | 28s |
| B03 | WHY | REMOTION | 22s |
| B04 | LAYOUT | VOX | 30s |
| B05 | YOUR TURN | VOX | 14s |
