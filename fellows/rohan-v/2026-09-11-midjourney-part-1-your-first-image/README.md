# Midjourney, Part One — Your First Image

Part 1 of 6 in the Midjourney tutorial series for new **Lyrical Literacy**
...
| | |
|---|---|
| **Runtime** | 3:20 (11 beats) |
| **Format** | 16:9, 3840×2160, 30 fps |
| **Voice** | Kokoro `af_bella` |
| **Presenter** | Rohan V. |
| **Built** | 2026-09-06 → 2026-09-07 |
| **Series** | **Part 1** · [Part 2](../2026-09-11-midjourney-part-2-writing-the-prompt/) · [Part 3](../2026-09-11-midjourney-part-3-what-to-do-with-one-you-like/) · [Part 4](../2026-09-11-midjourney-part-4-the-settings-panel/) · [Part 5](../2026-09-11-midjourney-part-5-getting-the-same-look-twice/) · [Part 6](../2026-09-11-midjourney-part-6-the-editor-and-where-your-work-lives/) · [interface research](../2026-09-11-midjourney-interface-research/) |

## What it covers

- getting in through the Humanitarians AI Discord
- the sidebar
- the imagine bar — type and submit
- the three progress states
- the rail beside a row of results
- hover
...
| [`review-capture-part-1-bug-1.png`](./review-capture-part-1-bug-1.png) | a review capture I took of a defect (see FRICTIONAL.md) |
...
assets stay here: [`Midjourney Tutorials/`](https://drive.google.com/drive/folders/1ibvpFnBZ5tzc1aHFZ0H8dTTspnLSGsfg) — `2026-09-16_midjourney-part-1_16x9.mp4`.
