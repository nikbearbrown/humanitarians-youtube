# Weekly Research Report: Testing the Two-Audience Brief

**Fellow:** Maya R. (fictional example)  
**Week ending:** July 17, 2026  
**Research source:** `/Users/bear/Documents/CoWork/bear-textbooks/books/madison/docs/exercises/exercise-05-conductor-brief.md`  
**Source status:** Instructional research document; it specifies an exercise and explicitly treats a first run as a future human-reviewed event.

This renderable weekly report asks: **What happens when persuasive prose and executable rules disagree?** It is a deep explainer grounded in Madison's actual local research. It does not claim that fictional Maya performed a live run.
...
This is Kore, in for Humanitarians AI. I asked what fictional fellow Maya R. explored this week: What happens when persuasive prose and executable rules disagree? The source points to a mechanism, and just as importantly, a boundary.
