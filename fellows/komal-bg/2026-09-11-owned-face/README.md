...
**Runtime:** ~2:17 · **Master:** 4K (3840×2160) + 9:16 short
**Narrator:** Liam (`am_onyx`), in for Komal
**Channel chip / handle on cut:** Komal

## What this video is about

Luxury used to rent a person's presence. Now a brand can mint the look.
An **AI campaign model** is inventory — a generated body for a still. A
**virtual influencer** is a persona that keeps posting. Human talent can
refuse. Those are not synonyms. Worked examples: Levi’s / Lalaland.ai
catalog test (2023) and Lil Miquela × Prada / Calvin Klein.
...
The clean 4K master (`claude-liam-owned-face.mp4`) and 9:16 short stay
local and are gitignored. Production source for this cut also lives locally at
`Sept 11 - Brutalist Updates/claude-liam-owned-face/` and is **not** part
of this PR.
