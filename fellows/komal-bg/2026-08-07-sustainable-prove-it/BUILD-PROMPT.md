# BUILD-PROMPT — Sustainable, Prove It. (Komal · 4K)

```
Build the claude-liam ai-explainer "Sustainable, Prove It."
(slug: claude-liam-eu-green-claims) — creator cut for Komal.

Ground truth:
1. humanitarians-youtube/claude-for-branding/youtube/claude-liam-eu-green-claims/beat_sheet.json
...
4. runtime/remotion/src/scenes/EmpCoIllu.tsx (registered in Root.tsx)
