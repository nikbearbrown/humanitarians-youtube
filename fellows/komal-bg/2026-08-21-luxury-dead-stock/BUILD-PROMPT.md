# BUILD-PROMPT — Dead Stock. (Komal · 4K)

```
Build the claude-liam ai-explainer "Dead Stock."
(slug: claude-liam-luxury-dead-stock) — creator cut for Komal.

Ground truth:
1. humanitarians-youtube/claude-for-branding/youtube/claude-liam-luxury-dead-stock/beat_sheet.json
...
4. runtime/remotion/src/scenes — DeadStock* patterns
   (DeadStockName, DeadStockBet, DeadStockBan, DeadStockForecast,
    DeadStockAllocate, DeadStockTell)
