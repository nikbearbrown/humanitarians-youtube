...
*Draft — Sections 1–7 complete, plus Section 4b reference implementation (15/15 tests passing). This entry's structural finding: HSBC's coding-assistant productivity story and its separately-announced, explicitly "agentic" financial-crime system are genuinely distinct disclosures, made months apart, that this case study connects only as an analytical contrast — not one HSBC has drawn itself. CRITIQ review pass complete; all CRITICAL and MAJOR findings addressed. Ready for README reconciliation and process logging.*
