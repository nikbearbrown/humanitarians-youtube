...
# The Brutalist Manim Shelf — Math-To-Manim

## What this video is about

**Topic:** Claude For Mathematics

This video explains the brutalist manim shelf — math-to-manim through a concrete example, visual reasoning, and a practical viewer handoff.

The current plan contains **an existing set of beats**. Its runtime is derived from the final narration. The source recorded by the project is: See the local source and fact-check files.
