...
# Build a Context Cost Type Breakdown Tool with Claude
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: cli-agnostic-ai-tooling-for-local-project-workflows/chapters/05-the-five-context-cost-types-where-your-tokens-are-going.md
