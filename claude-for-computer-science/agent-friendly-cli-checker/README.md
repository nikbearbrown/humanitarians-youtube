...
# Build an Agent-Friendly CLI Design Checker with Claude
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: cli-agnostic-ai-tooling-for-local-project-workflows/chapters/10-agent-workflow-patterns-that-actually-work.md
