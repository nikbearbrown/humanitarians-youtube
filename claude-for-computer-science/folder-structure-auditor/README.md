...
# Build a Folder Structure Auditor for Agent Reliability
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: cli-agnostic-ai-tooling-for-local-project-workflows/chapters/01-why-your-agent-reads-the-wrong-file.md
