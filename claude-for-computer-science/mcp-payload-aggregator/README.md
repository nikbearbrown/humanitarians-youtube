...
# Build a MCP Payload Aggregator: Raw Dump vs. Aggregated Response
...
The current plan contains **12 beats**. Its runtime is 113. The source recorded by the project is: cli-agnostic-ai-tooling-for-local-project-workflows/chapters/09-mcp-servers-and-context-the-silent-tax-youre-probably-paying.md
