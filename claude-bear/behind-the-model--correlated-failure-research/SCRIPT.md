...
`anthropics/youtube/behind-the-model/correlated-failure-research`
...
---
**GATE P — signed:** unattended filmloop (hai-simple, no human gate; free audio + slate cut IS the review)
