...
# 80 Days to Stay — Progress Report: Building the OPT Job Search Platform

## What this video is about

**Topic:** HUMANITARIANS AI

This is Kore for Humanitarians AI.

The current plan contains **10 beats**. Its runtime is derived from 10 beats. The source recorded by the project is: Humanitarians-AI
