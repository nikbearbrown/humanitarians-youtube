...
The current plan contains **17 beats**. Its runtime is derived from 17 beats. The source recorded by the project is: quantum-mechanics-vol1/chapters/08-the-free-particle-and-wave-packets.md
