...
# Why 1+2+3+4+... = −1/12 Is Not a Trick
...
The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: youtubers/chapters/analytic-continuation-the-jigsaw-puzzle-that-extends-zeta.md
