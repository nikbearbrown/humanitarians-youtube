...
# Kokoro: Free Voices (With Names)

## What this video is about

**Topic:** KOKORO — FREE VOICES

This is Kore for Humanitarians AI.

The current plan contains **14 beats**. Its runtime is 147.18. The source recorded by the project is: See the local source and fact-check files.
