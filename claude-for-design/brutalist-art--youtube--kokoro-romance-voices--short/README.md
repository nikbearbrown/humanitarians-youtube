...
# Kokoro: The 9 Romance-Language Voices (Spanish · Portuguese · Italian · French)

## What this video is about

**Topic:** KOKORO — ROMANCE 9

This is Humanitarians.

The current plan contains **13 beats**. Its runtime is 73.36. The source recorded by the project is: See the local source and fact-check files.
