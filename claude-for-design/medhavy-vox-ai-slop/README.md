...
# How a Hallucination Becomes a Citation

## What this video is about

**Topic:** INTERNET EPISTEMOLOGY

This is Liam for Humanitarians AI.

The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: youtubers/chapters/ai-slop-misinformation-feedback-loop.md
