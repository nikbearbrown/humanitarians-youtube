...
# Kokoro: The 4 Hindi Voices

## What this video is about

**Topic:** KOKORO — HINDI 4

This is Kore for Humanitarians AI.

The current plan contains **8 beats**. Its runtime is 46.29. The source recorded by the project is: See the local source and fact-check files.
