...
# Evidence Updates Beliefs, It Doesn't Replace Them
...
The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: youtubers/chapters/bayes-theorem-evidence-should-update-beliefs-not-replace-them.md
