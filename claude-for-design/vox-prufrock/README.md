...
The current plan contains **79 beats**. Its runtime is derived from 79 beats. The source recorded by the project is: See the local source and fact-check files.
