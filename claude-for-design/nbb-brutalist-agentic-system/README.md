...
# What is inside the Brutalist agentic system exactly?

## What this video is about

**Topic:** BRUTALIST SYSTEM TAXONOMY

One instruction, forty files moved: fps=24 ran deterministically; register:Teardown ran through an underdetermined pass gated for taste — that split is the whole taxonomy.

The current plan contains **19 beats**. Its runtime is 358.64. The source recorded by the project is: taxonomy provided in build prompt
