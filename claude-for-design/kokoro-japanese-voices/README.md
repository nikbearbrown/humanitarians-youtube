...
# Kokoro: The 5 Japanese Voices

## What this video is about

**Topic:** KOKORO — JAPANESE 5

This is Humanitarians.

The current plan contains **9 beats**. Its runtime is 176.11. The source recorded by the project is: See the local source and fact-check files.
