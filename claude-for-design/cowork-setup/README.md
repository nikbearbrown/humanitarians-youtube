...
# Claude Cowork, Set Up — Skills and Projects, Not Folders
...
The current plan contains **14 beats**. Its runtime is 120. The source recorded by the project is: Ruben Hassid, 'Learn 80% of Claude Cowork in 20 minutes' (Substack, Jul 2026) — his revised setup: forget files/folders, use Skills + Projects.
