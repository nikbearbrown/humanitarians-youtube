...
# The Seller With the Best Real Track Record
...
The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: youtubers/chapters/bayesian-ratings-and-the-binomial-distribution.md
