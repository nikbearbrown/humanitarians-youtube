...
The current plan contains **10 beats**. Its runtime is 160.27. The source recorded by the project is: Anthropic, 'Coding agents in the social sciences' (May 27, 2026). Lyttelton, Massenkoff, Wilmers. Survey of 1,260 quantitative social scientists, Feb–Mar 2026.
