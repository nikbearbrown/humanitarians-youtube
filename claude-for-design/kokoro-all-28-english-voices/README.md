...
# Kokoro: All 28 English Voices (The Full Roster)
...
The current plan contains **32 beats**. Its runtime is 22.65. The source recorded by the project is: See the local source and fact-check files.
