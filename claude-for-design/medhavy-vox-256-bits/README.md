...
# The Number That Makes Galaxy-Spanning Computers Look Weak
...
The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: youtubers/chapters/256-bits-the-number-that-breaks-your-imagination.md
