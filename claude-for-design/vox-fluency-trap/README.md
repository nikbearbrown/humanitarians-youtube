...
# Why the Group That Learned Less Was Sure It Learned More
...
The current plan contains **15 beats**. Its runtime is 114.76. The source recorded by the project is: See the local source and fact-check files.
