...
# How Pre-Sorting a Pivot Guarantees Linear Selection
...
The current plan contains **14 beats**. Its runtime is derived from 14 beats. The source recorded by the project is: youtubers/chapters/algorithms-median-of-medians-makes-selection-linear.md
