...
# Build a Spaced Study Scheduler with Claude: Memory Engineering Before the Exam
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: college-success-bundle-with-llms/chapters/06-studying-memory-and-test-taking.md
