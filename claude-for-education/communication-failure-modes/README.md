...
# Research Communication Failure Modes with Claude: Why the Illusion Takes Place
...
The current plan contains **12 beats**. Its runtime is 118. The source recorded by the project is: college-success-bundle-with-llms/chapters/08-communicating.md
